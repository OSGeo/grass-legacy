#include "gis.h"
/*  XD_do_conversions(window, win_width, win_height)
...
int win_width, win_height;
{
    ...
    WIND_TOP = (double) 0;
    WIND_BOT = (double) win_height;
    WIND_LEFT = (double) 0;
    WIND_RITE = (double) win_width;
...
/* Calculate Array window limits from UTM limits */
	ARRAY_COLS = (U_east - U_west + ew_resolution/2) / ew_resolution ;
...
double XD_get_u_to_a_yconv()
{
    return (U_to_A_yconv);
}

double XD_get_u_to_a_xconv()
{
    return (U_to_A_xconv);
}
...
double XD_get_a_to_d_yconv()
{
    return (A_to_D_yconv);
}

double XD_get_u_to_d_xconv()
{
    return (U_to_D_xconv);
}

double XD_get_u_to_d_yconv()
{
    return (U_to_D_yconv);
}

double XD_get_u_west()
{
    return (U_west);
}

double XD_get_u_east()
{
    return (U_east);
}

double XD_get_u_north()
{
    return (U_north);
}

double XD_get_u_south()
{
    return (U_south);
}

double XD_get_a_west()
{
    return (A_west);
}

double XD_get_a_east()
{
    return (A_east);
}

double XD_get_a_north()
{
    return (A_north);
}

double XD_get_a_south()
{
    return (A_south);
}
