	...
	caddr_t call_data;
{
	...
	efoo = XtCreateManagedWidget("env_window",
			formWidgetClass, eparams,
			arglist, 3);
	...
	etitl = XtCreateManagedWidget("etitl",
		labelWidgetClass, efoo,
		arglist, 6);
	...
	mapset = XtCreateManagedWidget("MAPSET      :",
		labelWidgetClass, efoo,
		arglist, 7);
	...
	XtSetArg(arglist[9], XtNeditType, XttextEdit);
	...
	mt = XtCreateManagedWidget("",
		asciiStringWidgetClass, efoo,
		arglist, 16);
	...
	gisdbase = XtCreateManagedWidget("GISDBASE   :",
		labelWidgetClass, efoo,
		arglist, 7);
