...
\fIv.in.tiger\fR.  It also provides tract number(s) which can be
used as input to the command \fIGen.Maps\fR.
.LP
\fBParameters:\fR
.IP \fIinfile\fR 18
...
.SH "SEE ALSO"
\fIm.tiger.region, v.in.tiger, v.db.rim, Gen.Maps, Gen.tractmap\fR
.SH AUTHOR
