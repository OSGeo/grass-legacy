...
/* INGRES modifications - no modifications in this routine
 *
 * Enhancements - Include the WHERE option. Not fully implemented.
 *
 * KJ 930411
 */
...
/*************** INFX/INGRES driver code begins ***************/
