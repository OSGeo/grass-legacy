{ test select file for r.reclass.inf -s, database=seco_soils, GISdb=SECO }
...
{
d.rast.inf key=grass_cat input=seco.soils output=seco.soils.recl tab=seco_soil_cats \
