...
/*  allocate psuedo struct, max points are four */
    ps_cp.count = 4;
    ps_cp.e1 = (double *) malloc (4*sizeof(double)); 
    ps_cp.n1 = (double *) malloc (4*sizeof(double));
    ps_cp.e2 = (double *) malloc (4*sizeof(double));
    ps_cp.n2 = (double *) malloc (4*sizeof(double));
    ps_cp.status = (int *) malloc (4*sizeof(int));
...
/**
         ps_cp.e2[k] = (j*(TIE_COL_DIST ));
         ps_cp.n2[k] = (i*(TIE_ROW_DIST ));
**/
