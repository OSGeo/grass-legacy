...
/*  double x,y;
    ...
    I_georef (group.con_points.e1, group.con_points.n1, &x, &y,
            group.E12, group.N12);
*/
    display_conz_points_in_view (VIEW_MAP1, in_color, 
            group.con_points.e1, group.con_points.n1,
	    group.con_points.status, group.con_points.count);
    ...
    display_conz_points_in_view (VIEW_MAP2, in_color,
	    group.con_points.e2, group.con_points.n2,
	    group.con_points.status, group.con_points.count);
