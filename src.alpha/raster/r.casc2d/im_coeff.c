 ...
 *
 */
   void coeff(area,areap,yp,y,qp,q,width,alpha,beta,
       rk,rkp,i,j,a,b,c,d,g,rpk,ap,bp,cp,dp,gp,grav,theta,delt,delx,
       yes_drain)
/*
 ...
 */
      float *area,*areap,
            ...
            *qp,*q,*width,
            *rk,*rkp,
            alpha,beta,*rpk,*a,*b,*c,*d,*g,
            *ap,*bp,*cp,*dp,*gp,grav,theta,delt,delx;
      int i,j,yes_drain;
{
 ...
 */
      ...
      float delts,arepi,arepi1,ypi,ypi1,arei,areis,areic,
          ...
          qpi1,qi,qis,qi1,wi,wi1,alpi,phi,vi,vi1,bet;
