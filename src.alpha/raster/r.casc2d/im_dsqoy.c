...
/**************************************************************/
void dsqoy(bottom,sslope,sslope2,strick,delx,yp,bel,nx1,dsdisch,ltype,
           chn_dep,mk0,pk0,mk1,pk1,xk,numhts,ht_spc,table_num,NUMBPTS)
 ...
 */
   ...
   float *bottom,*sslope,*sslope2,*strick,delx,*yp,*bel,*dsdisch;
   float *chn_dep;
   float *mk0,*pk0;
   float *mk1,*pk1;
   int *ltype;
...
/* Added with break point x-sect. description */
   float *xk,*ht_spc;
