...
/*********************************************************************/
 void flow_route(iter,itime,delt,delx,alpha,beta,theta,grav,
                      depend,backdep,nx1,bel,
                      yp,qp,strick,bottom,chn_dep,sslope,sslope2,
                      ltype,ndep,yfirst,ystep,qmin,
		      marea0,parea0,mtw0,ptw0,mk0,pk0,
		      marea1,parea1,mtw1,ptw1,mk1,pk1,numqpipe,yes_drain,
                    /* added by FLO 10-8-94 to incorp. brkpoint x-sect */
 ...
 */
 ...
 /*   Other Variables  */
      ...
      int   iter,*depend,*backdep,
            *nx1,itime,
            *ltype,*ndep;
      float delt,delx,alpha,beta,theta,grav,*bel,
            *yp,*qp,*strick,
            *bottom,*chn_dep,*sslope,*sslope2,
            yfirst,ystep;
      float qmin;
...
/*  Breakpoint x-sect variables */
      float *xarea,*xtw,*xk,*ht_spc;
      int *numhts,*table_num,maxtab,NUMBPTS;

/*  Added with DRAIN function */
    float lowspot,highspot,tdrain,normout;
{
 ...
 */
      ...
      int i,j,k,kk,uplinktype,downlinktype,lakenum;
