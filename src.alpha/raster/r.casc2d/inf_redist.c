...
/*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
void INF_REDIST(yes_redist_vary,vect,dt,vinf,itime,iter_pond_1,
			 iter_i_less_k,teta_n,vinf_n,yes_w_surf_moist,
...
float *K,*H,*P,*M,*LN,*RS;
float *vinf,*teta_n,*vinf_n,*surf_moist;
float *frate;
...
double  dtet,delteta,delvinf,p1,p2,rinf,sqrt();
double  d_inf_end_redist, d_inf_post_redist;
double  t_pond_1;

double  ln,tetar,i_eff_sat,i_hydcon;
