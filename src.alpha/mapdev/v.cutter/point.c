...
int
Cut_get_point_in_poly_t (Poly, X, Y)
    struct poly_t *Poly;
    double *X, *Y;
{
...
*/
int
Cut__intersect_line_with_poly (Points, y, I, poly)	/* DONE */
...
Cut_find_poly_centroid (points, cent_x, cent_y)	  /* DONE */
...
** returns -1 on error
*/
Cut_point_in_islands (Poly, cent_x, cent_y)	/* DONE */
    struct poly_t *Poly;
    double cent_x, cent_y;
{
    int i;
...
intersect_append_point (I, x, poly)	/* DONE */
    struct intersects *I;
    double x;
    int poly;
{
