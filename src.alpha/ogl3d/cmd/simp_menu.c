...
void
set_cur_cplane(w, opt, call_data)
    Widget w;
    int opt;
    caddr_t call_data;
{
...
void
set_active_cplanes(w, bnum, call_data)
    Widget w;
    int bnum;
    caddr_t call_data;
{
...
Widget
make_simple_options(parent, name, mylabel, labels, num, init, scb, wargs, n)
Widget parent;
char *name, *mylabel, *labels[];
int num, init, n;
void   (*scb)();
Arg wargs[];
{
...
Widget
make_simple_pupcheckbox(parent, name, mylabel, labels, num, init, scb, wargs, n)
Widget parent;
char *name, *mylabel, *labels[];
int num, init, n;
void   (*scb)();
