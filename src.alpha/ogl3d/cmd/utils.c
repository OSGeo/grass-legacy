...
*/
void
SetPositionArgs(wargs, pn, top, bottom, left, right, default_attachment)
Arg wargs[];
int *pn;
int top, bottom, left, right;
XtArgVal default_attachment;
{
int n;
