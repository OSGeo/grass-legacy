...
static xman_menu_struct Menu3Data[]={
  ...
  {" Animation... ",NULL,NULL,NULL,0,NULL},
  {" What's Here?... ",whats_here_panel,NULL,NULL,0,NULL},
  {" Scripting... ",nyi_pops,NULL,NULL,0,NULL}
};
/*
  {" Vectors... ",nyi_pops,NULL,NULL,0,NULL},
  {" Sites... ",sites_panel,NULL,NULL,0,NULL},
  {" What's Here?... ",whats_here_panel,NULL,NULL,0,NULL},
  {" Scripting... ",script_panel,NULL,NULL,0,NULL}
*/
...
********************************/
	...
	GLX_BLUE_SIZE, 4, GLX_ALPHA_SIZE, 0,
	None };
	/*
	*/
#endif
...
void
make_primary_controls(dc, argc, argv)
data_cell *dc;
int argc;
char *argv[];
{	
...
--------------------------------------------------------------------------*/
    ...
    width = dc->screen_size->width - 20;
    if (p = getenv ("X3D_WIDTH"))
	width = atoi(p) < width ? atoi(p):width ;
    height = dc->screen_size->height - 30;
...
*/
    n = 0;
    SetPositionArgs(wargs, &n, 0, 9, 0, 100, NULL);
    XtSetArg(wargs[n], XmNsaveUnder, TRUE);
...
*/
    ...
    n = 0;
    SetPositionArgs(wargs, &n, 10, -1, 75, 99, XmATTACH_NONE);
    ...
    n = 0;
    SetPositionArgs(wargs, &n, 17, -1, 1, 25, XmATTACH_NONE);
    ...
    n = 0;
    SetPositionArgs(wargs, &n, 17, -1, 25, 50, XmATTACH_NONE);
    ...
    n = 0;
    SetPositionArgs(wargs, &n, 17, -1, 50, 75, XmATTACH_NONE);
    ...
    n = 0;
    SetPositionArgs(wargs, &n, 17, -1, 75, 99, XmATTACH_NONE);
...
--------------------------------------------------------------------*/
    ...
    n = 0;
    SetPositionArgs(wargs, &n, 83, -1, 41, -1, XmATTACH_NONE);
...
/*-- Height Slider --*/	
    n = 0;
    SetPositionArgs(wargs, &n, 27, 77, 44, 50, NULL);
    ...
    n = 0;
    SetPositionArgs(wargs, &n, 27, -1, 51, -1, XmATTACH_NONE);
    XtCreateManagedWidget("Height", xmLabelGadgetClass,
	    dc->form_for_main_control_panel, wargs, n);

    n = 0;
    SetPositionArgs(wargs, &n, 32, -1, 51, -1, XmATTACH_NONE);
...
/*-- Zexag Slider --*/	
    n = 0;
    SetPositionArgs(wargs, &n, 27, 77, 70, 76, NULL);
    ...
    n = 0;
    SetPositionArgs(wargs, &n, 27, -1, 77, -1, XmATTACH_NONE);
    XtCreateManagedWidget("Z-Exag", xmLabelGadgetClass,
	    dc->form_for_main_control_panel, wargs, n);
    
    n = 0;
    SetPositionArgs(wargs, &n, 32, -1, 77, -1, XmATTACH_NONE);
...
*********************************************************************/
    ...
    n = 0;
    SetPositionArgs(wargs, &n, 27, 72, 1, 40, NULL);
    ...
    n = 0;
    SetPositionArgs(wargs, &n, 72, 82, 1, 40, NULL);
...
*********************************************************************/
    ...
    n = 0;
    SetPositionArgs(wargs, &n, 44, -1, 85, -1, XmATTACH_NONE);
    XtCreateManagedWidget("Look:",xmLabelGadgetClass, 
	    dc->form_for_main_control_panel, wargs,n);
    
    n = 0;
    SetPositionArgs(wargs, &n, 49, -1, 80, 95, XmATTACH_NONE);
...
******************************************************************/
    ...
    n = 0;
    SetPositionArgs(wargs, &n, 52, 62, 82, 97, NULL);
    ...
    n = 0;
    SetPositionArgs(wargs, &n, 64, 74, 82, 97, NULL);
    ...
    n = 0;
    SetPositionArgs(wargs, &n, 75, 85, 82, 97, NULL);
...
**************************************/
    ...
    n = 0;
    SetPositionArgs(wargs, &n, 90, 99, 85, 97, NULL);
...
--------------------------------------------------------------------*/
    ...
    dc->status_frame = XtCreateManagedWidget("", xmFrameWidgetClass, 
	    dc->frm, wargs,n);
