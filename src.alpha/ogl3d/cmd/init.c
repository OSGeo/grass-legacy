...
int i, j;
	...
	strcpy(dc->Atts[j][ATT_TRANSP].name,"transparency") ;
...
*/
sort_surfs_mid(id_orig, id_sort, indices, num)
int num, *id_orig, *id_sort, *indices;
{
int i, j;
...
/* Sorts surfaces by max elevation, lowest to highest.
   ...
   Puts ordered indices of surfaces from id_orig in indices.
*/
sort_surfs_max(id_orig, id_sort, indices, num)
int num, *id_orig, *id_sort, *indices;
{
int i, j;
