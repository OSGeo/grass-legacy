...
/* -- max amount defines -- */
#define MAX_SLIDERS 21 
#define MAX_GLOBALS 50 
#define MAX_TOGGLES 34 
...
typedef struct {
	...
	XColor colors;
	Colormap cmap;
	unsigned int cells[MAX_DYN_COLORS]; /* dynamic color cells */
	...
	Widget toggle_id[MAX_TOGGLES];   /* TODO: get rid of above dupes */
