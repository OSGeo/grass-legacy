    ...
    dbTable *table;
{
    ...
    G_message (stdout,_("table:%s\n"), db_get_table_name(table));
    G_message (stdout,_("description:%s\n"), db_get_table_description(table));
    ...
    char *label;
{
    ...
    switch (priv)
    {
    case DB_GRANTED:     G_message (stdout,_("yes")); break;
    case DB_NOT_GRANTED: G_message (stdout,_("no")); break;
    default:             G_message (stdout,_("?")); break;
    }
    G_message (stdout,_("\n"));
