...
int main ( int argc, char *argv[]) 
{
  ...
  struct
  {
    struct Option *input, *field, *zcol, *scol, *elev, *slope, *aspect, *pcurv, *tcurv, *mcurv, *treefile,
...
/*  fprintf (stdout, "Version: GRASS5.0 beta,  update: Novemebr 1999\n"); 
  ...
  parm.scol->description = "Name of the column containing smoothing parameters";
  ...
  parm.theta ->description = "Anisotropy angle (in degrees counterclockwise from East)";
