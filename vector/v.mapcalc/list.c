...
LIST *
listadd (LIST *head, LIST *elt, cmpfunc cmp)
{
  LIST *item, *prev = NULL;
...
LIST *
listaddnth (LIST *head, LIST *elt, int nth)
{
  LIST *item, *prev = NULL;
  int i;
...
LIST *
listunlinknth (LIST *head, int nth)
{
  LIST *item, *elt;
  int i;
...
LIST *
listdel (LIST *head, LIST *elt, freefunc func)
{
  if (!elt)
    return head;
...
LIST *
listdelnth (LIST *head, int nth, freefunc func)
{
  LIST *item, *elt;
  int i;
...
LIST *
listdup (LIST *head, cpyfunc cpy, size_t size)
{
...
LIST *
listsplitnth (LIST *head, int nth)
{
  LIST *item, *tail = NULL;
  int i;
...
LIST *
listsort (LIST *head, cmpfunc cmp)
{
...
LIST *
listdelall (LIST *head, freefunc func)
{
  LIST *item, *next;
...
inline void
listforeach (LIST *head, actfunc action)
{
  LIST *item;
...
LIST *
listfind (LIST *head, LIST *elt, cmpfunc cmp)
{
  LIST *item;
...
LIST *
listfinddatum (LIST *head, void *datum, cmpfunc cmp)
{
  LIST *item;
...
static LIST *
_listbsearch (LIST *min, int max, LIST *elt, cmpfunc cmp)
{
  LIST *item;
  int i, n, result;
...
LIST *
listbsearch (LIST *head, LIST *elt, cmpfunc cmp)
{
  LIST *item;
  int n, max, result;
...
static LIST *
_listbsearchdatum (LIST *min, int max, const void *datum, cmpfunc cmp)
{
  LIST *elt;
  int i, n, result;
...
LIST *
listbsearchdatum (LIST *head, const void *datum, cmpfunc cmp)
{
  LIST *elt;
  int n, max, result;
