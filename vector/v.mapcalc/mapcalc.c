...
int
cmpsymname (const void *data, const void *elt)
{
  SYMBOL *sym;
  const char *name;
...
int
cmpsymsym (const void *A, const void *B)
{
  SYMBOL *a, *b;
...
void
symcpy (const void *Dst, const void *Src)
{
  SYMBOL *dst, *src;
