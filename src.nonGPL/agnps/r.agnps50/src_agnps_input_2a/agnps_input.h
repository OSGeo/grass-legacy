...
/*  point sources.                                   */
        ...
        int     ptsrc_flag;     /* Indicates if any point sources at all  */  
        /***ptsrc_flag added by Mike Foster on September 3, 1995*/ 
        int     tptsrc;         /* Total number of point sources per cell */
