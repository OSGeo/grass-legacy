...
SetParameters ()
{
  ...
  param.input->description = _("Raster map(s) to be converted to VTK-ASCII data format");
  ...
  param.elevationmap->description = _("Raster map that represents the elevation, used for the 3D information");
  ...
  param.rgbmaps->description = _ ("3 raster maps (r,g,b) which are used to create rgb values [redmap,greenmap,bluemap]");
  ...
  param.usetriangle->description = _("Use polydata-trianglestrips for elevation grid creation");
