...

{
   ...
   diversity->key          	= "div";
   diversity->description  	= "d1 = richness      d2 = Shannon     d3 = dominance     d4 = inv. Simpson";
   ...
   edge->key          		= "edg";
   edge->description  		= "e1 = sum of edges  e2 = sum of edges by type (need edge file: r.le.para)";
   edge->options      		= "e1,e2";
