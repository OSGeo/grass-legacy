...
double 
offset_distance_LL (SHORT offset)
{
...
int 
completed_row_LL (EW *ewptr)
{
        return (!ewptr->walive && !ewptr->ealive);
}


int find_neighbors_LL (
    EW *ewptr, NEIGHBOR *nbr_head, SHORT row, SHORT col,
...
int 
exhaust_search_LL (EW *ewptr, NEIGHBOR *nbr_head, SHORT row, SHORT col)
{
    double      distance;
...
double 
distance_LL (SHORT row, SHORT col, MELEMENT *Mptr)
{
...
int 
LL_lookup_tables (SHORT nrows, SHORT ncols)
{
