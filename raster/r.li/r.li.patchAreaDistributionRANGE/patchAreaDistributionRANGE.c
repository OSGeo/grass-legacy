...
int main(int argc, char *argv[])
{
    ...
    module->description =_("Calculates range of patch area size on a raster file");
    ...
    return calculateIndex(conf->answer, patchAreaDistributionRANGE , NULL, raster->answer, output->answer);
