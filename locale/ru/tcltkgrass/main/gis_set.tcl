...
proc gisSetWindow {} {
    ...
    .frame0.intro.msg insert end "Добро пожаловать в GRASS GIS Version 5.0\n\n"
    .frame0.intro.msg insert end "Пожалуйста, выберите район и набор данных\n"
    .frame0.intro.msg insert end "или создайте новый район\n"
