...
extern void XD_RGB_raster(int,int,const unsigned char *,const unsigned char *,const unsigned char *,const unsigned char *);
extern void XD_RGB_set_colors(const unsigned char *,const unsigned char *,const unsigned char *);
extern void XD_Raster_int(int,int,const int *,int,int);
