...
int close_vect(FILE *);
int plot1(struct Map_info *, int, int, struct cat_list *, int, int, int, SYMBOL *, int, int, int, int, char *);
...
int darea(struct Map_info *, struct cat_list *, int, int, int, int, int, int, struct Cell_head *, char *);
