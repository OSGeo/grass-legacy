...
proc GmThematic::options { id frm } {
    ...
    SpinBox $row.b -range {1 50 1} -textvariable GmThematic::opt($id,iconsize) \
    ...
    ComboBox $row.b -padx 2 -width 3 -textvariable GmThematic::opt($id,legmon) \
