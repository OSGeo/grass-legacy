  ...
  L_is13z0:
    *iflg = 0;
    ...
    if (ipfile != NULL) {
        ...
        fprintf(ipfile, "\tLongitude of center = %16a\n", angs);
        fprintf(ipfile, "\tLatitude of center  = %16a\n", angs + 16);
  ...
  L_pf13z0:
    *iflg = 0;
    if (switch_ != 0)
        goto L120;
    if (ipfile != NULL)
        fprintf(ipfile, "pj13z0_0_: Uninitialized transformation\n");
    *iflg = 1300;
    return 0;
  L120:
    d_1 = geog[1] - lon0;
    ...
    if (g > epsln)
        goto L140;
    if (ipfile != NULL)
        fprintf(ipfile, "pj13z0_0_: Point projects into infinity\n");
    *iflg = 1301;
    return 0;
  L140:
    ksp = 1.0 / g;
