...
char *argv[];
    ...
    if ( debug )
	{
	pm_message( "IDLength = %d\n", (int) tga_head.IDLength, 0,0,0,0 );
	pm_message( "CoMapType = %d\n", (int) tga_head.CoMapType, 0,0,0,0 );
	pm_message( "ImgType = %d\n", (int) tga_head.ImgType, 0,0,0,0 );
	pm_message( "Index_lo = %d\n", (int) tga_head.Index_lo, 0,0,0,0 );
	pm_message( "Index_hi = %d\n", (int) tga_head.Index_hi, 0,0,0,0 );
	pm_message( "Length_lo = %d\n", (int) tga_head.Length_lo, 0,0,0,0 );
	pm_message( "Length_hi = %d\n", (int) tga_head.Length_hi, 0,0,0,0 );
	pm_message( "CoSize = %d\n", (int) tga_head.CoSize, 0,0,0,0 );
	pm_message( "X_org_lo = %d\n", (int) tga_head.X_org_lo, 0,0,0,0 );
	pm_message( "X_org_hi = %d\n", (int) tga_head.X_org_hi, 0,0,0,0 );
	pm_message( "Y_org_lo = %d\n", (int) tga_head.Y_org_lo, 0,0,0,0 );
	pm_message( "Y_org_hi = %d\n", (int) tga_head.Y_org_hi, 0,0,0,0 );
	pm_message( "Width_lo = %d\n", (int) tga_head.Width_lo, 0,0,0,0 );
	pm_message( "Width_hi = %d\n", (int) tga_head.Width_hi, 0,0,0,0 );
	pm_message( "Height_lo = %d\n", (int) tga_head.Height_lo, 0,0,0,0 );
	pm_message( "Height_hi = %d\n", (int) tga_head.Height_hi, 0,0,0,0 );
	pm_message( "PixelSize = %d\n", (int) tga_head.PixelSize, 0,0,0,0 );
	pm_message( "AttBits = %d\n", (int) tga_head.AttBits, 0,0,0,0 );
	pm_message( "Rsrvd = %d\n", (int) tga_head.Rsrvd, 0,0,0,0 );
	pm_message( "OrgBit = %d\n", (int) tga_head.OrgBit, 0,0,0,0 );
	pm_message( "IntrLve = %d\n", (int) tga_head.IntrLve, 0,0,0,0 );
	}
	...
	if ( maxval > PPM_MAXMAXVAL )
	    pm_error(
	      "CoSize is too large - try recompiling with a larger pixval type",
	      0,0,0,0,0 );
	}
    else
	...
	if ( maxval > PPM_MAXMAXVAL )
	    pm_error(
	   "PixelSize is too large - try recompiling with a larger pixval type",
	   0,0,0,0,0 );
	}
