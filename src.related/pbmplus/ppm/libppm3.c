...
#define ppm_hashpixel(p) ( ( ( (int) (p) * 353 ) & 0x7fffffff ) % HASH_SIZE )
#else /*PPM_PACKCOLORS*/
#define ppm_hashpixel(p) ( ( ( (int) PPM_GETR(p) * 33023 + (int) PPM_GETG(p) * 30013 + (int) PPM_GETB(p) * 27011 ) & 0x7fffffff ) % HASH_SIZE )
