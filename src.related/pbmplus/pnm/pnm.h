...
#define PNM_GET1(x) (x)
#define PNM_ASSIGN1(x,v) (x) = (v)
#define PNM_EQUAL(x,y) ( (x) == (y) )
#define PNM_FORMAT_TYPE(f) PGM_FORMAT_TYPE(f)
...
typedef bit xel;
typedef bit xelval;
#define PNM_MAXMAXVAL 1
#define PNM_GET1(x) (x)
#define PNM_ASSIGN1(x,v) (x) = (v)
#define PNM_EQUAL(x,y) ( (x) == (y) )
#define PNM_FORMAT_TYPE(f) PBM_FORMAT_TYPE(f)
