#ifndef lint
static char rcsid[] = "$Header: /usr/people/sam/tiff/libtiff/RCS/tif_thunder.c,v 1.11 90/10/08 17:18:02 sam Exp $";
#endif
...
#if USE_PROTOTYPES
static	int ThunderScanEncode(TIFF *, u_char *, int);
static	int ThunderScanDecode(TIFF *, u_char *, int);
#else
