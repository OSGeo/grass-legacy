#ifndef lint
static char *SCCSID = "@(#)SetEllips.c	USGS v.3.2";
#endif
/* definitions of geoids */
static struct { char *name, *a, *fb, *comment;
} *g, geoids[] = {
...
(char *)0, (char *)0, (char *)0, (char *)0};
	void	/* print list of internal geoids */
ell_list() {
	for ( g = geoids; g->name; ++g)
		printf("%10s: %-16s %-16s %s\n",
			g->name,g->a,g->fb,g->comment);
}
	int	/* select from internal geoids */
SetEllips(name) char *name; {
	for (g = geoids; g->name; ++g)
