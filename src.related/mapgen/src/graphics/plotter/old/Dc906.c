#ifndef lint
static char *SCCSID = "@(#)Dc906.c      OEMG v.3.2";
#endif
...
set[] = {
        ...
        static char
reset[] = {
        1, 9999 >> 12, (9999 >> 6) & 63, 9999 & 63, /* set search address */
        4, 1,           /* select pen 1 */
        ESC(0)          /* disable buffering */
};
        static char
d_code[][7] = {
