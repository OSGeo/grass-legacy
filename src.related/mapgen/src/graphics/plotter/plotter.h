...
# define XY struct _xy
# define XYS struct _xys

# define caseof(x) case x & _LBMASK
struct DEV_LIST {
	char *name;	/* if an interactive device, name should  */
			/* match value returned by getenv	  */
