...
int *float_x, *float_y, *button;
{
    ...
    mouse_set_cmd = VIO_SETXHAIR;
    mouse_mov_cmd = VIO_XHAIR;
...
int fixed_x, fixed_y, *float_x, *float_y, *button;
{
    ...
    mouse_set_cmd = VIO_SETRBOX;
    mouse_mov_cmd = VIO_RUBBOX;
...
int fixed_x, fixed_y, *float_x, *float_y, *button;
{
    ...
    mouse_set_cmd = VIO_SETRLINE;
    mouse_mov_cmd = VIO_RUBLINE;
...
int *float_x, *float_y, *button;
{
    ...
    args.arg5 = 1;
    ioctl(viofd, mouse_set_cmd, &args);
	...
	if (mouse_data.x != oldx || mouse_data.y != oldy)
	    ...
	    oldx = args.arg3 = mouse_data.x;
    	    ...
    	    ioctl(viofd, mouse_mov_cmd, &args);
	}
    }
