 ...
 */
    ...
    Tcl_CreateCommand(interp, "Nliteral_from_logical",
		      Nliteral_from_logical_cmd, (ClientData) mainWindow,
		      (void (*)()) NULL);
    Tcl_CreateCommand(interp, "Nlogical_from_literal",
		      Nlogical_from_literal_cmd, (ClientData) mainWindow,
		      (void (*)()) NULL);
    ...
    Tcl_CreateCommand(interp, "Nchange_height", Nchange_height_cmd, data,
		      NULL);
    Tcl_CreateCommand(interp, "Nget_first_exag", Nget_first_exag_cmd, data,
		      NULL);
    ...
    Tcl_CreateCommand(interp, "Nget_def_color", Nget_def_color_cmd, data,
		      NULL);
    ...
    Tcl_CreateCommand(interp, "Nget_point_on_surf", Nget_point_on_surf_cmd,
		      data, NULL);
    Tcl_CreateCommand(interp, "Nget_point_on_pg_grass",
		      Nget_point_on_surf_pg_grass, data, NULL);
    Tcl_CreateCommand(interp, "Nget_point_on_pg_site",
		      Nget_point_on_surf_pg_site, data, NULL);
    ...
    Tcl_CreateCommand(interp, "Nsurf_draw_all", Nsurf_draw_all_cmd, data,
		      NULL);
    Tcl_CreateCommand(interp, "Nsurf_draw_one", Nsurf_draw_one_cmd, data,
		      NULL);
    Tcl_CreateCommand(interp, "Nvect_draw_all", Nvect_draw_all_cmd, data,
		      NULL);
    Tcl_CreateCommand(interp, "Nvect_draw_one", Nvect_draw_one_cmd, data,
		      NULL);
    ...
    Tcl_CreateCommand(interp, "Nget_dist_along_surf",
		      Nget_dist_along_surf_cmd, data, NULL);
    Tcl_CreateCommand(interp, "Nget_cat_at_xy", Nget_cat_at_xy_cmd, data,
		      NULL);
    Tcl_CreateCommand(interp, "Nget_val_at_xy", Nget_val_at_xy_cmd, data,
		      NULL);
    ...
    Tcl_CreateCommand(interp, "Nset_interp_mode", Nset_interp_mode_cmd,
		      data, NULL);
    Tcl_CreateCommand(interp, "Nset_tension", Nset_tension_cmd, data, NULL);
    ...
    Tcl_CreateCommand(interp, "Nupdate_frames", Nupdate_frames_cmd,
		      data, NULL);
    Tcl_CreateCommand(interp, "Nset_numsteps", Nset_numsteps_cmd, data, NULL);
    Tcl_CreateCommand(interp, "Nclear_keys", Nclear_keys_cmd, data, NULL);
    Tcl_CreateCommand(interp, "Nadd_key", Nadd_key_cmd, data, NULL);
    Tcl_CreateCommand(interp, "Ndo_framestep", Ndo_framestep_cmd, data, NULL);
    ...
    Tcl_CreateCommand(interp, "Nwrite_rgb", Nwrite_rgb_cmd, data, NULL);
    Tcl_CreateCommand(interp, "Nwrite_ppm", Nwrite_ppm_cmd, data, NULL);
    Tcl_CreateCommand(interp, "Nwrite_tif", Nwrite_tif_cmd, data, NULL);
    Tcl_CreateCommand(interp, "Nstart_zoom", Nstart_zoom_cmd, data, NULL);
    Tcl_CreateCommand(interp, "Noff_screen", Noff_screen_cmd, data, NULL);

    /* Cutplane Junk */
    Tcl_CreateCommand(interp, "Ncutplane_obj", Ncutplane_obj_cmd, data, NULL);
    ...
    Tcl_CreateCommand(interp, "Nset_current_cutplane",
		      Nset_current_cutplane_cmd, data, NULL);
    Tcl_CreateCommand(interp, "Nget_current_cutplane",
		      Nget_current_cutplane_cmd, data, NULL);
    Tcl_CreateCommand(interp, "Nget_cutplane_list", Nget_cutplane_list_cmd,
		      data, NULL);
    Tcl_CreateCommand(interp, "Nset_fence_color", Nset_fence_color_cmd, data,
		      NULL);
    Tcl_CreateCommand(interp, "Nget_fence_color", Nget_fence_color_cmd, data,
		      NULL);
    Tcl_CreateCommand(interp, "Nget_xyrange", Nget_xyrange_cmd, data, NULL);

    /* Miscellanious */
    Tcl_CreateCommand(interp, "Nsave_3dview", Nsave_3dview_cmd, data, NULL);
    Tcl_CreateCommand(interp, "Nload_3dview", Nload_3dview_cmd, data, NULL);
    Tcl_CreateCommand(interp, "Nplace_label", Nplace_label_cmd, data, NULL);
}
