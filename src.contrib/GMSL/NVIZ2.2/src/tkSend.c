/*
 * This is a slightly modified version of tkSend where I have disabled
 * security.  Make sure that senders are careful since any commands
 * may be sent to nvwish interpreters.
 */
