 ...
 * tkBind.c --
 *
 * This is a slightly modified version of the original tk bind code.
 * We use this modified version to allow scripting for nviz.
 */
...
/* Externs for saving script information */
extern int Nv_script_state;
extern FILE *Nv_script_file;
...
#define STATIC_SPACE 200
		...
		/* Scripting code goes here eventually */
		if (Nv_script_state)
		  fprintf(Nv_script_file,"catch {send $ProcessName {%s}}\n",p);
