...
/* Generate lookup for "standard" colors */
	...
	assign_standard_color(INDIGO,  _get_lookup_for_color(  0,   0, 128)) ;
	...
	assign_standard_color(GRAY,    _get_lookup_for_color(127, 127, 127)) ;
	assign_standard_color(BROWN,   _get_lookup_for_color(128,  64,   0)) ;
	assign_standard_color(MAGENTA, _get_lookup_for_color(255,   0, 255)) ;
	assign_standard_color(AQUA,    _get_lookup_for_color(  0, 255, 255)) ;
