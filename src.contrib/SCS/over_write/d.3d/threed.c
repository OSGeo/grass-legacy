...
/* Provide for plotting from north and south if necessary */
    if ((from_northing > window.south) && (from_northing < window.north))
    {
        ...
        do_plot(row_end-row_dir,break_row-row_dir,-row_dir,col_beg,col_end,col_dir,interactive,&window,&colors) ;
        do_plot(row_beg,break_row+row_dir,row_dir,col_beg,col_end,col_dir,interactive,&window,&colors) ;
    }
    else
    {
        do_plot(row_beg,row_end,row_dir,col_beg,col_end,col_dir,interactive,&window,&colors) ;
    }
