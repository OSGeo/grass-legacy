	...
	char **argv ;
{
	...
	int color1, color2;
	char *color_list = "red,orange,yellow,green,blue,indigo,violet,gray,white,black";
...
/* Initialize the GIS calls */
	...
	parm.out->key = "output";
	parm.out->description = "output file name";
	parm.out->type = TYPE_STRING;
	parm.out->required = NO;
	...
	measurements(color1, color2, parm.out->answer) ;
