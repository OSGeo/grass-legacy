...
char *easting, *northing;
{
	...
	/* If the window is outside of current map window, ignore */;
  	if (R < (int)D_get_d_west())
	      ...
	      fprintf(stderr,"Label point NOT in current active window\n");
              fprintf(stderr," Label point is less than west\n");
	      sleep(2);
	      return(0) ;
	      }
	if (L > (int)D_get_d_east())
	      {
	      fprintf(stderr,"Label point NOT in current active window\n");
              fprintf(stderr," Label point is greater than east\n");
	      sleep(2);
	      return(0) ;
	      }
	if (B < (int)D_get_d_north())
	      {
	      fprintf(stderr,"Label point NOT in current active window\n");
              fprintf(stderr," Label point is less than north\n");
	      sleep(2);
	      return(0) ;
	      }
	if (T > (int)D_get_d_south())
	      {
	      fprintf(stderr,"Label point NOT in current active window\n");
              fprintf(stderr," Label point is greater than south\n");
	      sleep(2);
	      return(0) ;
	      }
	return(1);
