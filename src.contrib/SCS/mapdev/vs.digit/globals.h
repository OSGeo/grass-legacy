...
Global char Auto_Number;	  /* Automatic cat number selection*/
...
Global char *N_cats_file;	/* scs */
Global char *N_region_file;	/* scs */
...
Global int In_Debug;
Global int Next_l, Next_t;
Global int Interrupt;
Global int got_region, wind_savd, file_savd;
Global int cats_changed, subj_changed ;
Global int _main, _digit, _edit, _label, _tool, _custom, _wind, _zoom;

Global char CLR_SCALE;
Global char *N_region;
Global char *N_region_mapset;
Global char *N_overlay_mapset;
Global char *options[100];
Global char *buttons[100];
Global char *message[100];
