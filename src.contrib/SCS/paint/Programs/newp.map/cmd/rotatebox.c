...
void 
getbox (double rot, int border, int bg)
{
...
/*
fprintf (stdout,"rbox.bottom is %d \n", rbox.bottom);
fprintf (stdout,"rbox.top is %d \n", rbox.top);
fprintf (stdout,"rbox.left is %d \n", rbox.left);
fprintf (stdout,"rbox.right is %d \n", rbox.right);
*/
