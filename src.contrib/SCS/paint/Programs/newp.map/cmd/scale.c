...
int 
scale (struct Cell_head *window, int panel, int margin, char *text)
{
...
static double 
do_scale (struct Cell_head *window, int panel, int margin, char *text)
{
    char unit1[30];
    char unit2[30];
    char equals[30];
...
int 
unscaled (struct Cell_head *window, int rows, int cols)
{
    double ns, ew;
