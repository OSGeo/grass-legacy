 ...
 */
static 
mix (short *low, short *hi, short *extra, int *level_to_255, int nlevels, int steps)
{
    int color;
    int i;
...
static 
dither (unsigned char *color, int row, int col, int ncols, short *low, short *hi, short *extra)
{
    short *dp;
