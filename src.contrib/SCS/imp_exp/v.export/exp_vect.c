...
ask_which_level()
{
	...
	printf("     3  -   Ascii SCS_GEF file from GRASS Vector Format\n") ;
	printf("     4  -   Ascii ARC/INFO file from GRASS Vector Format\n") ;
	printf("     5  -   Ascii DXF file from GRASS Vector Format\n") ;
