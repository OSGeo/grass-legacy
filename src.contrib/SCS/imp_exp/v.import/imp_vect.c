...
ask_which_level()
{
	...
	fprintf (stdout,"     5  -   Ascii SCS-GEF file to GRASS Vector Format\n") ;
	fprintf (stdout,"     6  -   Ascii ARC/INFO file to GRASS Vector Format\n") ;
	fprintf (stdout,"     7  -   Ascii DXF file to GRASS Vector Format\n") ;
	fprintf (stdout,"     8  -   Ascii TIGER file to GRASS Vector Format\n") ;
