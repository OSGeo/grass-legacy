	...
	char **argv ;
{
	...
	nrcsflag = G_define_flag();
	nrcsflag->key		= 'c';
	nrcsflag->description	= "Condensed  TIGER file";
	...
	if (imp_tig(&Map,digopt->answer,cfcopt->answers, tig_file1,tig_file2,dig_att,nrcstig,verbose) == -1)
