    ...
    struct bdig_head *HEAD;
{
	...
	FGET ;			/* read a record */
	sscanf(buff,"%lf",&HEAD->orig_scale);
	FGET ;			/* read a record */
	strcpy(HEAD->other_info,buff);
	FGET ;			/* read a record */
	sscanf(buff,"%lf",&HEAD->N);
	FGET ;			/* read a record */
	sscanf(buff,"%lf",&HEAD->S);
	FGET ;			/* read a record */
	sscanf(buff,"%lf",&HEAD->E);
	FGET ;			/* read a record */
	sscanf(buff,"%lf",&HEAD->W);
	FGET ;			/* read a record */
	sscanf(buff,"%lf",&HEAD->map_thresh);
	FGET ;			/* read a record */
	sscanf(buff,"%lf",&HEAD->xofset);
	FGET ;			/* read a record */
	sscanf(buff,"%lf",&HEAD->yofset);
	FGET ;			/* read a record */
