...
printf("        1) linear regression: y=a[0]x[0]+a[1]\n");
...
printf("        4) NDVI \n");
printf("        5) intensity NDVI \n");
printf("        6) reflectance NDVI \n");
printf("        7) HRVI (Half Relaxation Vegetation Index) \n");
printf("        8) RVI (Relaxation Vegetation Index) \n");
printf ("> ");
...
if(flag_prediction  == 0)
{
    ...
    while(1)
    {
	printf("Enter number of sampling data. [1-%d]: ", ndata);
