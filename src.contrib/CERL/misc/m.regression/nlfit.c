...
int 
nlsetup (int ma, int mx, int mdata, void (*functions)(void))
...
int 
nlfit (double *x, double *y, double *a, double *chisq)
{
    int k,j;
...
static 
abc (double *x, double *y, double *a, double **alpha, double *beta, double *dyda, double *chisq)
{
    int k,j,i;
    double fy,wt,dy,*xp;
