...
GLOBAL Actuator *Aoptions, *Asave, *Aread, *Acancel, *Amorvect;
GLOBAL Actuator *Ascale, *Asites, *Anewsite;
...
GLOBAL Actuator *Atwist, *Aexagval, *Aexaglab, *Aortho;

GLOBAL Panel *P_Lights, *P_Mvmt, *P_Script, *P_Options, *P_Vect, *P_Menus;
GLOBAL Panel *P_Path, *P_Keyframe, *P_Scale, *P_Label;
