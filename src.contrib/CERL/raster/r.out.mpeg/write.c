...
#ifndef USE_PPM
/*******************************************************/
write_ycc (char *tr, char *tg, char *tb, int nrows, int ncols, int *y_rows, int *y_cols, char *filename)
{
register int x, y;
...
/*******************************************************/
int 
write_ppm (char *tr, char *tg, char *tb, int nrows, int ncols, int *y_rows, int *y_cols, char *filename)
{
register int x, y;
static int rows, cols;
static int  first = 1;
...
/*******************************************************/
int write_params (char *mpfilename, char *yfiles[],
     char *outfile, int frames, int quality,
     int y_rows, int y_cols, int fly)
{
FILE *fp;
...
/*******************************************************/
int 
clean_files (char *file, char *files[], int num)
{
char cmd[1000];
int i;
