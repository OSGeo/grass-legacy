...
do_init (char *program)
{
   ...
   {
      G_fatal_error (" INTERNAL ERROR: %s '%s'.\n",
...
/*==========================================================================*/
int 
print_title (FILE *fid, char *title)
{
   int  i;
   int  len;
   char buff1[WORDLEN];
...
/*==========================================================================*/
int 
non_blank_line (FILE *fid, char *buffer)
{
   char *newline;
   char  token[BUFFLEN];
...
/*==========================================================================*/
int 
blank_pad (char *buffer, int nbytes)
{
   int   i;
...
/*==========================================================================*/
int 
r_justify (char *field, char *word, int field_len)
{
   int  word_len;
   int  offset;
...
/*==========================================================================*/
int 
get_dindex (int nitems, double list[], double value)
{
   int i;
   int index = -1;
   int found = FALSE;
...
/*==========================================================================*/
int 
get_sindex (int nitems, char *list[], char *string)
{
   int i;
   int index = -1;
   int found = FALSE;
...
/*==========================================================================*/
double 
distance_sq (double x, double y, double x1, double y1)
{
   double dx, dy;
   double dist2;
...
/*==========================================================================*/
int free_2d (char **list, int nlist)
{
   int i;
...
/*==========================================================================*/
int 
value_fmt (double value, char *fmt_str, int fmt_type, int brief)
{
   int  i;
   int  j;
   int  tindx;
...
/*==========================================================================*/
double 
dist_factor (int base_unit, int new_unit)
{
   double factor;
...
/*==========================================================================*/
double 
cvt_dist (double distance, int base_unit, int new_unit)
{
   double answer;
...
/*==========================================================================*/
double 
cvt_area (double area, int base_unit, int new_unit)
{
   int    dist_unit;
   double answer;
   double d_factor;
...
/*==========================================================================*/
double 
cvt_volume (double vol, int base_unit, int new_unit)
{
   int    dist_unit;
   double answer;
   double d_factor;
...
/*==========================================================================*/
int 
coord_to_cell (struct Cell_head window, double loc_north, double loc_east, int *row, int *col)
{
   static int nrows;
...
/*==========================================================================*/
int 
screen_to_utm (struct Cell_head window, int screen_x, int screen_y, double *utm_x, double *utm_y)
{
   int     row, col;
