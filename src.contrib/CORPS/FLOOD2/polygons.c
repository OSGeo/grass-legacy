...
calc_areas (int nsites)
{
  ...
  area = (double*) G_malloc( nsites * sizeof(double) );
  if ( !area )
...
/*==========================================================================*/
int 
polygon_area (float poly[][2], int nverts, double *total_area)
{
...
/*============================================================================*/
int 
plot_polygon (char *color, float poly[][2], int nverts)
{
   int i, j;
   int line_color;
