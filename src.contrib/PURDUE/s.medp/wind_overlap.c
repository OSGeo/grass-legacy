...
int 
G_window_overlap (struct Cell_head *window, double N, double S, double E, double W)
{
...
double 
G_window_percentage_overlap (struct Cell_head *window, double N, double S, double E, double W)
{
    double V,H;
    double n,s,e,w;
    double shift;
