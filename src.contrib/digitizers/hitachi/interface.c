...
D_setup_origin()
{
	/*  this is not needed in the Hitachi  */
}
...
*   are numbered.  An ALTEK buttons are 0-F, a KURTA is 1-16, HITACHI is
*   1-9,0,*,#.  It doesn't  matter what this returns if you don't have
*   a cursor with buttons..
*/
...
/*  keep reading until a button (1-4) is hit  */
