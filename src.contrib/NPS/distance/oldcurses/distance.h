...
/* This "distance.h" contains the include to "oldcurses.h"                   */
#include <oldcurses.h>
/* NOTE:  When executing "Gmake" the variable "CURSES" should equal          */
/* "-loldcurses $(TERMLIB)" when using this "distance.h" which contains the  */
/* the include to "oldcurses.h".                                             */
