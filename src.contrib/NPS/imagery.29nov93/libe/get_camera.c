...
#else
static int   read_group_camera  (FILE *fd, Camera cam_info);
static int   write_group_camera (FILE *fd, Camera cam_info);
#endif
...
-----------------------------------------------------------------------*/
I_get_group_camera (group_name, camera)
char    *group_name;
Camera  *camera;
{
  FILE *fd;
...
/*-----------------------------------------------------------------------
  ...
  Returns:
    ...
    -2  : Error writing to file.
     1  : o.k.
-----------------------------------------------------------------------*/
I_put_group_camera (group_name, camera)
char   *group_name;
Camera  camera;
{
  FILE *fd;
...
-----------------------------------------------------------------------*/
static int
write_group_camera (fd, cam_info)
    FILE *fd;
    Camera cam_info;
{
  int i;
