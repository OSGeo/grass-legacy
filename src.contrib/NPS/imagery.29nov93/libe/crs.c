...
void CRS_georef2(order,E,N,e,n,numpts)
...
int CRS_georef(e1,n1,e,n,E,N,order)
...
int CRS_compute_georef_equations(cp,E12,N12,E21,N21,order)
Control_Points_2D *cp;
double  *E12, *N12, *E21, *N21;
/** double E12[], N12[], E21[], N21[]; **/
int order;
  {
  double *tempptr;
...
static int checkgeoref(cp,E,N,order,forward,fp)
Control_Points_2D *cp;
double E[];
double N[];
int order;
