...
#else
static int   read_init_info  (FILE *fd, Camera cam_info);
static int   write_init_info (FILE *fd, Camera cam_info);
#endif
...
-----------------------------------------------------------------------*/
I_get_group_expose (group_name, camera_expose)
char           *group_name;
...
/*-----------------------------------------------------------------------
  ...
  Returns:
    ...
    -2  : Error writing to file.
     1  : o.k.
-----------------------------------------------------------------------*/
I_put_group_expose (group_name, camera_expose)
char          *group_name;
Camera_Expose  camera_expose;
{
  FILE *fd;
