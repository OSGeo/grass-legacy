...
#else
static char *Parse(int argc, char *argv[], Landsat *landsat);
...
char *argv[];
{
   ...
   while(1) {
	 ...
	 header = realloc(header, size);
      ...
      printf("The first file read must be a volume header.\n");
...
======================================================================*/
static char *Parse(argc, argv, landsat)
int argc;
char *argv[];
Landsat *landsat;
{
