...
static void EnterFilename(FileSequence*, int band);
#endif
...
======================================================================*/
int FileSeqInit(fileseq, prompt, name, suffix, blocksize)
...
======================================================================*/
int FileSeqRead(fileseq, dest, length)
FileSequence *fileseq;
unsigned char *dest;
int length;
{
...
======================================================================*/
static int MountTape(first)
boolean first;
{
   char buffer[10];

   printf("Mount the %s tape and hit return (Enter 'quit' to exit): ",
      first ? "first" : "next");
...
======================================================================*/
static void EnterFilename(fileseq, band)
FileSequence *fileseq;
int band;
{
   if(band >= 1)
      printf("Enter filename for band %d (Hit return to quit): ", band);
   else
      printf("Enter next filename (Hit Return to quit): ");
