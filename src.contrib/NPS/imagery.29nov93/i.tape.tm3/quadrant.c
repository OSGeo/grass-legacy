...
$Id: quadrant.c,v 1.3 1993/03/01 20:33:49 clesher Exp $
...
======================================================================*/
long ImportQuadrant(landsat, header, length)
Landsat *landsat;
...
Return Value:
   ...
   1 if error.
======================================================================*/
int ImportBand(landsat, band, tminfo)
Landsat *landsat;
int band;
TMinfo  *tminfo;
{
...
Return Value:
   ...
   1 on error.  Text record could not be found, or next file could not be
      found.
======================================================================*/
int ExamineQuadrant(landsat, header, length, info, tminfo)
Landsat *landsat;
...
TMinfo *tminfo;
{
   ...
   if(numrecs > 23 || RecordType(p) != TEXT) {
      printf("Volume directory has no volume text record.\n");
      return(1);
   }
...
======================================================================*/
void MonthAndDay(year, julian, month, day)
int year, julian;
int *month, *day;
{
