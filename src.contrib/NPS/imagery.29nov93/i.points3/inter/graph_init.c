...
Init_graphics()
{
    ...
    */
    ...
    COLOR_BLACK  = D_translate_color ("black");
    COLOR_BLUE   = D_translate_color ("blue");
    COLOR_BROWN  = D_translate_color ("brown");
    COLOR_GREEN  = D_translate_color ("green");
    COLOR_GREY   = D_translate_color ("grey");
    COLOR_ORANGE = D_translate_color ("orange");
    COLOR_PURPLE = D_translate_color ("purple");
    COLOR_RED    = D_translate_color ("red");
    COLOR_WHITE  = D_translate_color ("white");
    COLOR_YELLOW = D_translate_color ("yellow");
