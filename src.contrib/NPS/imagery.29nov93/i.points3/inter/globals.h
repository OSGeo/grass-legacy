...
#define COLOR_BLACK  THE_COLORS[0]
#define COLOR_BLUE   THE_COLORS[1]
#define COLOR_BROWN  THE_COLORS[2]
#define COLOR_GREEN  THE_COLORS[3]
#define COLOR_GREY   THE_COLORS[4]
#define COLOR_ORANGE THE_COLORS[5]
#define COLOR_PURPLE THE_COLORS[6]
#define COLOR_RED    THE_COLORS[7]
#define COLOR_WHITE  THE_COLORS[8]
#define COLOR_YELLOW THE_COLORS[9]
