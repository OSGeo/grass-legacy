...
int main (int argc, char *argv[])
{
    ...
    static int cmd_loop_count = LOOP_PER_SERVICE;  
...
/*  				fputc('+',stderr); */
            ...
            case CONNECTION_BEGIN:
                debug("CONNECTION_BEGIN");
                break;
            case CONNECTION_END:
                debug("CONNECTION_END");
                break;
/*              case START_DRAWING: */
/*                  debug("START_DRAWING"); */
/*                  break; */
...
static int send(char *buf, int n)
{
