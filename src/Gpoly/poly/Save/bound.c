...
int size;
{
  ...
  buffer[0] = (CELL *) G_malloc(size * sizeof(CELL));
  buffer[1] = (CELL *) G_malloc(size * sizeof(CELL));
...
static int assign_area(cat,kase)
CELL cat;
int kase;
{
  a_list_new->free = 0;
...
static int update_width(ptr,kase)
