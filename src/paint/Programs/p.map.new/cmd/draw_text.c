...
static int process_text (char *,int,int,int);

extern BOX rbox;
extern float rrot;

int draw_text (char *string, int x, int y, int drawflag)
{
    int i;
    BOX box;
...
int text_bounds (char *string, int x, int y, BOX *box, int drawflag)
{
    _top = _bottom = y;
    _left = _right = x;
...
int text_line (int x1, int y1, int x2, int y2, int drawflag)
{
    if (!_draw)
    {
        if (y1 < _top)    _top = y1;
...
int 
set_text_background (int b)    { background = b; return 0; }
int 
set_text_border (int b)        { border = b; return 0; }
int 
set_text_color (int c)         { color = c; hcolor = -1; return 0; }
int 
set_text_rotation (int r)      { rotation = r; return 0; }
int 
set_text_size (double s) { size = s * scale; return 0; }
int 
set_text_width (int w)         { width = w; hwidth = 0; return 0; }
int 
set_text_xref (int x)          { xref = x; return 0; }
int 
set_text_yref (int y)          { yref = y; return 0; }
int 
set_text_scale (double s) { scale = s; return 0; }
int 
set_text_hwidth (int w)        { hwidth = (w>0?(2*w):0); return 0; }
int 
set_text_hcolor (int c)        { hcolor = c; return 0; }
 ...
 */
int 
set_reasonable_text_size (void)   { set_text_size(0.4); return 0; }
