...
static Internal_istaque* cast (s)
     Basic_istaque_adt s;
...
Basic_istaque_adt basic_istaque_new (minsize)
     int minsize;
...
void basic_istaque_push (s, value)
     Basic_istaque_adt s;  /* input/output */
     int value;
...
void basic_istaque_print (s, file)
     Basic_istaque_adt s;
     FILE *file;
     /* Prints elements of s to given file. */
{
  ...
  fprint (file, "Basic_istaque_adt 0x%x-> (%d;0x%x,%d,%d;0x%x,%d,%d,%d) ",
          q, q->minsize,
...
double basic_istaque_resize (s, resize_code)
     Basic_istaque_adt s;  /* input/output */
     double resize_code;
