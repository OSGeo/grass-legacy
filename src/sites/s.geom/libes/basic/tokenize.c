...
int basic_tokenize (string, token, maximum)
     char string[];  /* input/output --- NOTE: The string will be destroyed! */
     char *token[];  /* output, assuming: token[0..maximum-1] */
     int maximum;
