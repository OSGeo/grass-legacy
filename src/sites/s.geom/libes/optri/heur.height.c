...
static int 
hhHeightCashGet (origin, from, to, area, length)
...
static
hhComputeHeight (origin, from, to, area, length, status)
...
int
hhHeightLT (g, origin1, from1, to1, origin2, from2, to2)
...
void
hhPrintHeight (fp, oi, ox, oy, oz, fi, fx, fy, fz, ti, tx, ty, tz)
