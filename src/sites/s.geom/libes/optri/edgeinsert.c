...
localGT (g, triple1, triple2)
     ...
     graphType * g;
     localTriangleType * triple1, * triple2;
...
testInsideWedge (g, candidate, wedge, isInsideRight, isInsideLeft)
     ...
     indexType candidate;
     wedgeType *wedge;
     int      *isInsideRight, *isInsideLeft;
...
doEdgeInsertion (modus, local_g, local_visual, local_pool,
     ...
     poolType   *local_pool;
     int       (*local_applicationGT) ();
     int       (*local_applicationRightTurn) ();
