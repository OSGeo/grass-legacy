...
** Changed new sites API (new sites format) back to old API to use with 4.2.1
     Markus Neteler & Jacques Bouchard 1998
  ...
  int argc;
{
  ...
  int omnidirectional, decfield = 1;
  ...
  nsites = readsites (fdsite, 0, verbose, &z);
  }
  else
  {
    fdsite = stdin;
