  ...
  100 FORMAT(2X,'TEST4  DAGN   =',F10.4)
      ...
      DIMENSION X(1000),Y(2),FX(1000),FN1(1000),FN2(1000)
      DIMENSION T(1000),Z(1000),D(2),FN3(1000),X1(1000)
      REAL MEAN
      SUM1=0
      SUM2=0
      SUM3=0
  ...
  100 FORMAT(2X,'TEST6  WU2(N) =',F10.4)
      ...
      DIMENSION X(1000),C(1000),X1(1000),G(1000),Z(1000),B(1000),Y(2)
      R=FLOAT(N)
      SUMX=0
      SUMX2=0
      DO 10 I=1,N
  ...
  100 FORMAT(2X,'TEST11 KSD    =',F10.4)
      ...
      DIMENSION X(1000),Y(2),V(1000),V2(1000),F(1000)
      DIMENSION P(1000),Z(1000)
      EXTERNAL xinormal
      EXTERNAL dl
      REAL MEAN
      SUM1=0
  ...
  100 FORMAT(2X,'TEST12 CS(N)  =',F10.4,'   DOF  =',F10.4)
      ...
      DIMENSION X(1000),X1(1000),Y(2),A(25)
      SUMB=0
      SUMX=0
      SUMX2=0
      K=N/2
  ...
  160 CONTINUE
      ...
      DIMENSION X(1000),X1(1000),Y(2),Z(1000),P(1000)
      EXTERNAL xinormal
      EXTERNAL dl
      SUMA=0
      SUMB=0
  ...
  100 FORMAT(2X,'TEST20 AD(E)  =',F10.4)
      ...
      DIMENSION X(1000),Y(2),V(1000),V2(1000),F(1000),P(1000)
      REAL MEAN
      SUM1=0
      SUM3=0
      A=4*((0.75*(N-1)*(N-1))**2)
