...
u_long gemask = ExposureMask | ButtonPressMask | StructureNotifyMask;
Pixmap bkupmap;
int truecolor;

unsigned long *xpixels;	/* lookup table for FIXED color mode */

extern void Find_TrueColor_Visual(void);
...
find_truecolor_visual(void)
{
    ...
    search_template.class  = scrn;
    search_template.screen = TrueColor;
