...
if (helpcode)
   ...
   /* check font */
   if (!(!strcmp(config.font,"standard") || !strcmp(config.font,"cyrillic") ||
       ...
       !strcmp(config.font,"romand")   || !strcmp(config.font,"romanp") ||
       !strcmp(config.font,"romant")   || !strcmp(config.font,"romans") ||
       !strcmp(config.font,"scripts")  || !strcmp(config.font,"scriptc")))
       {
