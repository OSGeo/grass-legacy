...
F_menu (Choicefile, Helpfile, Choice, Respbuf, Flags, curline, hilite)
...
P_writo_Menu_win (Windoname, Bufptr, Firstline, Buflength,
	Numlines, hilite, response)
WINDOW		*Windoname;
char		*Bufptr;
int			*hilite ;
int		Firstline, Buflength, Numlines;
