...
#define pw_box(pixwin, x0, y0, x1, y1, brush, tex, op) \
        pw_line(pixwin, x0, y0, x0, y1, brush, tex, op); \
        pw_line(pixwin, x0, y1, x1, y1, brush, tex, op); \
        pw_line(pixwin, x1, y1, x1, y0, brush, tex, op); \
        pw_line(pixwin, x1, y0, x0, y0, brush, tex, op) 
