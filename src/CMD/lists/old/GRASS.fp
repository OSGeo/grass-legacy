...
src/scripts
#######################################
src.alpha/display/d.labels
src.alpha/display/d.rast.arrow
src.alpha/display/d.rast.edit
src.alpha/display/d.rast.num
src.alpha/display/d.rast.zoom
src.alpha/imagery/i.cluster
src.alpha/imagery/i.gensig
src.alpha/imagery/i.gensigset
src.alpha/imagery/i.in.erdas
src.alpha/imagery/i.ortho.photo
src.alpha/imagery/i.quantize
src.alpha/imagery/i.rectify2
src.alpha/imagery/i.smap
src.alpha/imagery/i.tape.spot
src.alpha/imagery/i.tape.tm.fast
src.alpha/imagery/i.vpoints
src.alpha/mapdev/moss
src.alpha/mapdev/v.alabel
src.alpha/mapdev/v.apply.census
src.alpha/mapdev/v.cutter
src.alpha/mapdev/v.in.arc
src.alpha/mapdev/v.in.tig.basic
src.alpha/mapdev/v.in.tig.lndmk
src.alpha/mapdev/v.in.transects
src.alpha/mapdev/v.out.arc
src.alpha/mapdev/v.proj
src.alpha/mapdev/v.reclass
src.alpha/mapdev/v.to.sites
src.alpha/paint/Programs/p.map.new/cmd
src.alpha/ps.map
src.alpha/raster/r.colors.paint
src.alpha/raster/r.contour
src.alpha/raster/r.cost
src.alpha/raster/r.digit
src.alpha/raster/r.in.poly
src.alpha/raster/r.in.sunrast
src.alpha/raster/r.line
src.alpha/raster/r.mask.points
src.alpha/raster/r.median
src.alpha/raster/r.mode
src.alpha/raster/r.out.tga
src.alpha/raster/r.rescale.eq
src.alpha/raster/r.surf.contour
src.alpha/raster/r.thin
src.alpha/raster/r.weight2
src.alpha/sites/s.surf.tps
src.alpha/misc/m.dem.extract
src.alpha/misc/m.flip
src.alpha/misc/m.in.pl94.db3
src.alpha/misc/m.in.stf1.db3
src.alpha/misc/m.in.stf1.tape
src.alpha/misc/m.lulc.USGS
src.alpha/misc/m.lulc.read
src.alpha/misc/m.proj
src.alpha/misc/m.tiger.region
