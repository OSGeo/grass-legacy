...
echo "       gmake5 -i src.garden/grass.postgresql"
echo "       gmakelinks5 -i"
echo ""
echo "* ODBC driver please compile as:"
echo "       gmake5 -i src/libes/dbmi/drivers/odbc"
echo "       gmakelinks5 -i"
echo ""
...
echo "  to gmake5 and gmakelinks5. For example, for PostgreSQL the commands"
echo "  may be as follows:"
echo "	 /home/grass/bin.i686-pc-linux-gnu/gmake5 -i src.garden/grass.postgresql"
echo "	 /home/grass/bin.i686-pc-linux-gnu/gmakelinks5 -i"
echo ""
