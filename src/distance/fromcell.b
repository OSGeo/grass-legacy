 ...
 * this assumes that the data in CELL buffer is within the range for MAPTYPE
 * the distance program only uses value 0-60 so this assumption is
 * valid even if MAPTYPE is char
 */
    mapptr = MAP;
    for( k = 0 ; k < NROWS ; k++)
    {
