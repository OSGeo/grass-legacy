...
char *G_get_next_marked_d_raster_cat(struct Categories *, DCELL *, DCELL *, long *);
char *G_get_next_marked_c_raster_cat(struct Categories *, CELL *, CELL *, long *);
char *G_get_next_marked_f_raster_cat(struct Categories *, FCELL *, FCELL *, long *);
char *G_get_next_marked_raster_cat(struct Categories *, void *, void *, long *, RASTER_MAP_TYPE);
...
int G_set_raster_cat(void *, void *, char *, struct Categories *, RASTER_MAP_TYPE);
...
char *G_get_ith_raster_cat(struct Categories *, int, void *, void *, RASTER_MAP_TYPE);
...
int G_set_raster_cats_fmt(char *, double, double, double, double, struct Categories *);
...
/* cellstats_eq.c */
int G_cell_stats_histo_eq(struct Cell_stats *, CELL, CELL, CELL, CELL, int, void (*)());
/* clear_scrn.c */
...
int G_get_raster_color(void *, int *, int *, int *, struct Colors *, RASTER_MAP_TYPE);
...
/* color_look.c */
int G_lookup_colors(CELL *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, int, struct Colors *);
int G_lookup_c_raster_colors(CELL *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, int, struct Colors *);
int G_lookup_raster_colors(void *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, int, struct Colors *, RASTER_MAP_TYPE);
int G_lookup_f_raster_colors(DCELL *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, int, struct Colors *);
int G_lookup_d_raster_colors(DCELL *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, int, struct Colors *);
int G__lookup_colors(void *, unsigned char *, unsigned char *, unsigned char *, unsigned char *, int, struct Colors *, int, int, RASTER_MAP_TYPE);
int G__interpolate_color_rule(DCELL, unsigned char *, unsigned char *, unsigned char *, struct _Color_Rule_ *);
/* color_org.c */
...
/* color_rule.c */
int G_add_d_raster_color_rule(DCELL *, int, int, int, DCELL *, int, int, int, struct Colors *);
int G_add_f_raster_color_rule(FCELL *, int, int, int, FCELL *, int, int, int, struct Colors *);
int G_add_c_raster_color_rule(CELL *, int, int, int, CELL *, int, int, int, struct Colors *);
int G_add_raster_color_rule(void *, int, int, int, void *, int, int, int, struct Colors *, RASTER_MAP_TYPE);
int G_add_color_rule(CELL, int, int, int, CELL, int, int, int, struct Colors *);
int G_add_modular_d_raster_color_rule(DCELL *, int, int, int, DCELL *, int, int, int, struct Colors *);
int G_add_modular_f_raster_color_rule(FCELL *, int, int, int, FCELL *, int, int, int, struct Colors *);
int G_add_modular_c_raster_color_rule(CELL *, int, int, int, CELL *, int, int, int, struct Colors *);
int G_add_modular_raster_color_rule(void *, int, int, int, void *, int, int, int, struct Colors *, RASTER_MAP_TYPE);
int G_add_modular_color_rule(CELL, int, int, int, CELL, int, int, int, struct Colors *);
/* color_ryg.c */
...
int G_fpreclass_get_limits(struct FPReclass *, DCELL *, DCELL *, DCELL *, DCELL *);
int G_fpreclass_nof_rules(struct FPReclass *);
void G_fpreclass_get_ith_rule(struct FPReclass *, int, DCELL *, DCELL *, DCELL *, DCELL *);
...
void G_quant_get_ith_rule(struct Quant *, int, DCELL *, DCELL *, CELL *, CELL *);
