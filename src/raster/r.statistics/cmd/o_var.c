...
o_var(basemap,covermap,outputmap,usecats,cats)
...
{      
 ...
 int i;
   ...
   if(n < 1)
   {
    fprintf(stderr,"o_var: No data in array\n");
    return (1);
   }
