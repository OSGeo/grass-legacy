      ...
      INTEGER*2 NL,NS,DFILE,MFILE,UPDOWN,PASS,I,I1,I2,I3,II,INDEX2
      INTEGER*2 INDEX,INDEX1,J,DIRX,ITEMP
      INTEGER*2 DIR(20000,3),MASK(20000,3)
      COMMON DIR,MASK
...
C
C 700  CONTINUE
C      OPEN(UNIT=DFILE,STATUS='OLD',RECL=(NS+1)/2,
C     *   FORM='UNFORMATTED',ACCESS='DIRECT',
C     *   file=DIFILE)
C      OPEN(UNIT=MFILE,STATUS='OLD',FORM='UNFORMATTED',
C     *   ACCESS='DIRECT',file=MAFILE,RECL=(NS+1)/2)
C      GOTO 13
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
...
C
C 710  CONTINUE
C      OPEN(UNIT=DFILE,STATUS='OLD',RECL=NS,
C     *   FORM='UNFORMATTED',ACCESS='DIRECT',
C     *   file=DIFILE)
C      OPEN(UNIT=MFILE,STATUS='OLD',FORM='UNFORMATTED',
C     *   ACCESS='DIRECT',file=MAFILE,RECL=NS)
C      GOTO 13
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
 13   UPDOWN=-1
