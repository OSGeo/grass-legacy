...
void set_min_f(void *v){ *(FCELL *)v=MINFLOAT; }
void set_min_d(void *v){ *(DCELL *)v=MINDOUBLE; }

/* initialize memory to a maximum value */
void set_max_c(void *v){ *(CELL *)v=INT_MAX; }
void set_max_f(void *v){ *(FCELL *)v=MAXFLOAT; }
void set_max_d(void *v){ *(DCELL *)v=MAXDOUBLE; }
