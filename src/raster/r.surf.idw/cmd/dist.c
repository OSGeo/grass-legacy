...
double 
LL_set_geodesic_distance_lat (double lat)
{
...
int 
LL_set_geodesic_distance (
    double *rowlook,	/* preprocessed latitude data by row */
    int unk,
    int data	/* row (y) of interpolation target, data value */
)
{
