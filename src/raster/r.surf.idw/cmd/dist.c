...
double LL_set_geodesic_distance_lat (lat)
    double lat;
{
...
LL_set_geodesic_distance (rowlook, unk, data)
double	*rowlook;	/* preprocessed latitude data by row */
short	unk, data;	/* row (y) of interpolation target, data value */
{
