/*
   ...
   April 1991
   Update: March 1992 (add vector overlay, misc touchups)
   Update: May 1992   (removed parser routine to ask about
                       grid color, since that can be changed
                       easily enough with the menu. added a
                       lookup of cell value ranges, and ability
                       to edit negative cell values. also more
                       misc touchups)
...
/* note: grid color used to be an option set with the help
   of the parser, but it was more bother than worth. if black
   is not what the user wants, they can reset it with the
   menu */
