...
#ifndef USE_PPM
/*******************************************************/
write_ycc(tr, tg, tb, nrows, ncols, y_rows, y_cols, filename)
...
/*******************************************************/
write_ppm(tr, tg, tb, nrows, ncols, y_rows, y_cols, filename)
char *tr, *tg, *tb, *filename;
int nrows, ncols, *y_rows, *y_cols;
{
register int x, y;
...
/*******************************************************/
write_params(mpfilename, yfiles, outfile, frames, quality, y_rows, y_cols, fly)
