...
#define N 350              /* Max number of units allowed in net */
...
float TrainingInputs[10000][N];
float TrainingOutputs[10000][N];
float TestInputs[10000][N];
float TestOutputs[10000][N];
