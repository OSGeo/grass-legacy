...
#endif
/*
$Header: /hdf/hdf/v3.2r2/src/RCS/dfsdf.c,v 1.7 1992/10/30 18:36:52 koziol beta $

$Log: dfsdf.c,v $
 * Revision 1.7  1992/10/30  18:36:52  koziol
 * Fixed casts in a bunch of functions to make the SGI ANSI compiler happy
 *
 * Revision 1.6  1992/10/27  22:18:31  koziol
 * changed fortran stub for DFSDpre32() to use new calling interface
 *
 * Revision 1.5  1992/10/12  18:11:51  koziol
 * Updated for v3.2r2 release
 *
 * Revision 1.4  1992/09/15  19:40:05  koziol
 * Folded Shiming's intn changes and the changes to fix non-square datasets
 *
