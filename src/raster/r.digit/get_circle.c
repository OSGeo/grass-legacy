...
get_circle (fd, labels)
    FILE *fd;
    struct Categories *labels;
{
    extern double hypot(), sqrt();
    int ok;
    ...
    printf ("Mark the center of the circle\n");
    instructions(0);
    instructions(1);
    ...
    do
    {
	printf("Mark a point on the perimeter\n");
