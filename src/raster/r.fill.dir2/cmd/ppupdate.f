      ...
      CHARACTER*6 SYSTEM
      REAL*2 LEVEL(4002,3),STACK(2000),MAPTO(2,2000)
      REAL*2 MASK(4002,3),ALLPPTBL(8,2000)
...
c
     ...
     *  LINE,I1,I2,I3,INDEX)
      ...
      REAL*2 MASK(4002,3),ELEV(4002,3),ALLPPTBL(8,2000)
      LOGICAL ELOG
      COMMON MASK,ELEV
      COMMON /TBL/ALLPPTBL
...
C
      ...
      logical done
      REAL*2 MASK(4002,3),LEVEL(4002,3)
