...
C
      ...
      CHARACTER*6 SYSTEM
      REAL*2 BRIDGE
      DIMENSION MASK(20000,2),SDIR(20000)
      DIMENSION MAPTO(21,5000)
      DIMENSION LINK(5000),STACK(5000)
      COMMON /MAPS/MAPTO
...
C
 700  CONTINUE
     ...
     *   FORM='UNFORMATTED',ACCESS='DIRECT',
     *   file=LIFILE)
      OPEN(UNIT=MFILE,STATUS='NEW',RECL=(NS+1)/2,
     *   FORM='UNFORMATTED',ACCESS='DIRECT',file=MAFILE)
      GOTO 13
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
...
C
 710  CONTINUE
     ...
     *   FORM='UNFORMATTED',ACCESS='DIRECT',
     *   file=LIFILE)
      OPEN(UNIT=MFILE,STATUS='NEW',RECL=NS,
     *   FORM='UNFORMATTED',ACCESS='DIRECT',file=MAFILE)
      GOTO 13
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
 ...
 5    MASK(I,1)=-1
      ...
      DO 15 J=2,NS-1
      MASK(J,I2)=-1
      IF(SDIR(J).EQ.0)MASK(J,I2)=0
      IF(SDIR(J).GE.0)GOTO 15
...
C== READ AND WRITE
 ...
 300  WRITE(MFILE,REC=I)(MASK(II,1),II=1,NS)
      END
C
      REAL*2 FUNCTION BRIDGE(M1,M2,M3,M4)
      IMPLICIT REAL*2(A-Z)
      DIMENSION M(4),MAPTO(21,5000)
      COMMON /MAPS/MAPTO
      M(1)=M1
      M(2)=M2
      M(3)=M3
