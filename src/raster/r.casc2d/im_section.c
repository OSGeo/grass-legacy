...
/*******************************************************************/
 void section(bottom,sslope,sslope2,strick,yp,bel,areap,
	      rkp,rpk,width,nx1,ltype,chn_dep,
              marea0,parea0,mtw0,ptw0,mk0,pk0,
              marea1,parea1,mtw1,ptw1,mk1,pk1,
              /* added by FLO 10-8-94 to add breakpoint x-sects */
 ...
 */
  ...
  float *yp,*strick,*sslope,*sslope2,*bottom,*bel;
  float *areap,*rkp,*width,*rpk,*chn_dep;
  float *marea0,*parea0,*mtw0,*ptw0,*mk0,*pk0;
  float *marea1,*parea1,*mtw1,*ptw1,*mk1,*pk1;
  int *nx1,*ltype;

/*  Added to describe break point x-sect description 10-8-94 */
  float *xarea,*xtw,*xk,*ht_spc;
  int *table_num,*numhts,maxtab,NUMBPTS;
