...

{
	...
	{
	   printf("The combination of %d, %s and %s is not defined!!\n",
           land_use_label,mgmt_pr,hy_cond_label);
           printf("Please reclassify the map and refer AGNPS user manual\n");
           printf("for proper surface condition constant\n");
	   clean_up();
	   exit(0);
	}
}
