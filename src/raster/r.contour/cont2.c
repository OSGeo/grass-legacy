...
void
contour (levels, nlevels, Map, z, Cell, Att, quiet, noerr)
...
****************************************************************************/
int 
findcrossing (struct cell *current, double level, struct Cell_head Cell, struct line_pnts *Points)
{
	int i, j;
...
************************************************************************/
void 
getpoint (struct cell *curr, double level, struct Cell_head Cell, struct line_pnts *Points)
{
	double x, y;
	double ratio;
 	int p1, p2;	
