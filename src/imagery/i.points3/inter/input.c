...
#define TEXT_COLOR I_COLOR_BLACK
#define FILL_COLOR I_COLOR_GREY

#define TITLE_COLOR I_COLOR_YELLOW
#define OPTITLE_COLOR I_COLOR_GREEN
#define INFO_COLOR  I_COLOR_WHITE
#define OUTLINE_COLOR  I_COLOR_YELLOW
