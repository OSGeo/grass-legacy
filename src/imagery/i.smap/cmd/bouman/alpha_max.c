...
int  M;       /* Number of class types */
{
        ...
        a[0]=eps*b[0]; a[1]=eps*b[1]; a[2]=eps*b[2];
...
int M;         /* number of classes */
{
        ...
        for (n2 = 0; n2<=2; n2++)
        for (n3 = 0; n3<=1; n3++) {
          tmp =log(a[0]*(n1-iM)+a[1]*(n2-2.0*iM)+a[2]*(n3-iM)+iM);
          sum += N[n1][n2][n3]*tmp;
        }
        return(sum);
}
...
int M;            /* number of classes */
{
        ...
        for (n2 = 0; n2<=2; n2++)
        for (n3 = 0; n3<=1; n3++) {
          tmp=a[0]*(n1-iM)+a[1]*(n2-2.0*iM)+a[2]*(n3-iM)+iM;
          tmp = 1/tmp;
