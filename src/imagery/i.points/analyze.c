...
compute_transformation()
{
    ...
    Compute_equation();
    if (group.equation_stat <= 0) return;
 ...
 */
	...
	count++;
	I_georef (group.points.e2[n], group.points.n2[n], &e1, &n1, group.E21, group.N21);
	I_georef (group.points.e1[n], group.points.n1[n], &e2, &n2, group.E12, group.N12);
