...
static
drawvect(zoomit,zoom_view,E,N,trans_order)
...
top   = active_view->top;
	...
	Curses_write_window (INFO_WINDOW, 1, 13, "COORDINATES");
    	...
    	sprintf(msg, "N = %10.2lf   E = %10.2lf",                                           VIEW_MAP2->cell.head.north, VIEW_MAP2->cell.head.east);
    	Curses_write_window (INFO_WINDOW, 5, 4, msg);
    	sprintf(msg, "S = %10.2lf   W = %10.2lf",                                           VIEW_MAP2->cell.head.south, VIEW_MAP2->cell.head.west);
    	Curses_write_window (INFO_WINDOW, 6, 4, msg);

    	Curses_write_window (INFO_WINDOW, 9, 2, "ZOOM WINDOW");
    	sprintf(msg, "N = %10.2lf   E = %10.2lf",                                           VIEW_MAP2_ZOOM->cell.head.north, VIEW_MAP2_ZOOM->cell.head.east);
    	Curses_write_window (INFO_WINDOW, 11, 4, msg);
    	sprintf(msg, "S = %10.2lf   W = %10.2lf",                                           VIEW_MAP2_ZOOM->cell.head.south, VIEW_MAP2_ZOOM->cell.head.west);
