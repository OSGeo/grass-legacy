        ...
        char *argv[];
{
 ...
 int index_in_prev= -1, index_out_prev= -1; 
 int sph_in, sph_out;
 double a_in,a_out,es_in,es_out;
 int i, npr, in_stat;
...
/*  actions   */
   ...
   case 1: 		        
     parms_in[0] = '\0';
     proj_changed_in = process(1,parms_in,proj_name_in,proj_title_in,
                 ellps_name_in,radius_in,USED_in,units_in);
     ...
     parms_out[0] = '\0';
     proj_changed_out = process(0,parms_out,proj_name_out,proj_title_out,
...
/* --------------------- Input Selection ------------------------ */
            ...
            while (input_typ == 0)
	    {
	      ...
	      if (strlen(answer) == 0)   input_typ = 1;
                ...
                if (*answer != '1' && *answer != '2' ) input_typ = 3; 
...
/* --------------------- Output Selection ------------------------ */
            ...
            while (output_typ == 0)
	    {
	      ...
	      if (strlen(answer) == 0)   output_typ = 1;
                ...
                if (*answer != '1' && *answer != '2' ) output_typ = 3; 
