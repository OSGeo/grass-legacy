...
/* int plot_quadratic (HGN *list) */

int plot_quadratic (list, parameters, nwork, verbose, save)
  char * save;
  int nwork, verbose;
  HGN *list;
  PARAM parameters;
 ...
 * file for plotting the working list with a rational quadratic
 * semivariogram model defined in structure {\tt parameters}. Does
 * not check to see if model parameters are given.
 */
{
  ...
  fprintf (tmp_file, "set title 'Rational Quadratic Semivariogram'\n");
