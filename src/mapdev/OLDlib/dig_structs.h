...
/*  User must make sure it is included before this file */
...
struct Map_info
{
    char *name;			/* Title of map (future) */
    short id;			/* Internal Id reference (future) */
...
/* BE Sure <stdio.h> is included */
    FILE *digit;		/* Dig file pointer */
    FILE *att;			/* Att file pointer */
    char *digit_file;		/* digit file */
    char *att_file;			/* attribute file */
