...
break_lines_at_segs_w_point (map, ux, uy, A, Aseg, APoints, B, Bseg, BPoints, node)
    struct Map_info *map;
    double ux, uy;
    int  A, B;		/* line indexes */
    int Aseg, Bseg;	/* segment to break line at */
...
break_line_at_seg_w_point (map, ux, uy, line, segment, Points, on_node)
    struct Map_info *map;
    double ux, uy;
...
break_line_at_segs_w_point (map, ux, uy, line, Aseg, Bseg, Points, on_node)
    struct Map_info *map;
    double ux, uy;
    int  line;		/* line indexe */
    int Aseg, Bseg;	/* segment to break line at */
