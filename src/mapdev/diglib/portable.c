...
dig__Init_portable_code (portable)
{
    static int First = 1;
    static int ret = 0;
...
double *
dig__double_convert (in, out, count, head)
    double *in, *out;
    int count;
...
float *
dig__float_convert (in, out, count, head)
    float *in, *out;
    int count;
    struct dig_head *head;
{
...
#ifdef INCLUDE_SHORT
short *
dig__short_convert (in, out, count, head)
    short *in, *out;
    int count;
    struct dig_head *head;
{
...
long *
dig__long_convert (in, out, count, head)
    long *in, *out;
    int count;
    struct dig_head *head;
{
...
*/
long *
dig__int_convert (in, out, count, head)
    int *in;
    long *out;
    int count;
    struct dig_head *head;
...
*/
long *
dig__plus_t_convert (in, out, count, head)
    plus_t *in;
    long *out;
    int count;
    struct dig_head *head;
...
*/
int *
dig__long_convert_to_int (in, out, count, head)
    long *in;
    int *out;
    int count;
    struct dig_head *head;
...
*/
plus_t *
dig__long_convert_to_plus_t (in, out, count, head)
    long *in;
    plus_t *out;
    int count;
    struct dig_head *head;
