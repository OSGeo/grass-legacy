...
/*******************************************************************************
*      in.h          This file contains function definitions for the <in>      *
...
int openf(char *, int);
int closef(int);
char *reada(char *, int, int);
char *reada_old(char *, int, int);
char *trim(char *);
char *lowerc(char *);
/* graph_input.c */
long raw_diginput(void);
long decode_digpkt(char []);
long start_ginput(char [], int);
int start_run_mode(void);
int start_point_mode(void);
int start_query_mode(void);
long query_ginput(void);
long stop_ginput(void);
long ginput_ctl(long, ACTION *);
long read_digfile(char *);
long read_value(char [], char [], ACTION *);
long digdefaults(void);
long set_diginternals(void);
long ginput_setup(char *, char *, int);
int dig_input(int *, int *);
long bslash(char *);
long dparse(char [], char [], char *, long, long, long, long);
