...
int _Write_header_info (void)
{
    ...
    sprintf(buf, "%-ld", CM->head.orig_scale) ;      wmove(BASE_WIN,5,18) ;  waddstr(BASE_WIN, buf);
    ...
    sprintf(buf, "%20ld", CM->head.orig_scale) ;      wmove(BASE_WIN,5,16) ;  waddstr(BASE_WIN, buf);
