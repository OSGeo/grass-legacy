...
write_plus_asc(map,  fp_ascii, fp_plus)
	struct Map_info *map;
	FILE   *fp_ascii ;
	FILE   *fp_plus ;
{
...
write_nodes_asc(map,  ascii, plus, Plus)
	FILE   *ascii ;
	FILE   *plus ;
	struct Plus_head *Plus ;
	struct Map_info *map;
...
write_lines_asc( map, ascii, plus, Plus)
	FILE   *ascii ;
	FILE   *plus ;
	struct Plus_head *Plus ;
	struct Map_info *map;
...
write_areas_asc(map,  ascii, plus, Plus)
	FILE   *ascii ;
	FILE   *plus ;
	struct Plus_head *Plus ;
	struct Map_info *map;
...
write_atts_asc(map,  ascii, plus, Plus)
	FILE   *ascii ;
	FILE   *plus ;
	struct Plus_head *Plus ;
	struct Map_info *map;
...
write_isles_asc(map,  ascii, plus, Plus)
	FILE   *ascii ;
	FILE   *plus ;
	struct Plus_head *Plus ;
	struct Map_info *map;
