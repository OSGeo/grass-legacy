    ...
    struct Map_info *map; 
{
    ...
    sprintf(file, "%s/%s/%s/%s/%s", G_gisdbase(), G_location(), mapset, "dig", name);
    ...
    sprintf(file, "%s/%s/%s/%s/%s", G_gisdbase(), G_location(), mapset, "dig_plus", name);
    ...
    sprintf(file, "%s/%s/%s/%s/%s", G_gisdbase(), G_location(), mapset, "dig_att", name);
