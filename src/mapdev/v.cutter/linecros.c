...
int test_for_intersection (double ax1, double ay1, double ax2, double ay2,
...
int 
find_intersection (double ax1, double ay1, double ax2, double ay2, double bx1, double by1, double bx2, double by2, double *x, double *y)
{
