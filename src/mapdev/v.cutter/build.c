...
*/
build_polys (Maps, MapC, Table)		/* ==ISLE== */
...
*/
load_active_list (Table, active, poly, code)	/* ==ISLE==*/
    struct t_data *Table;
...
int
find_next_intersection (active, Vert, Vert2, ab_mode, in_out, Poly) /*==ISLE==*/
  struct array_p *active;
...
vert2_after_vert1 (Vert, Vert2, Polys, AB_MODE)
  struct poly_vert_info *Vert;
  struct poly_vert_info *Vert2;
