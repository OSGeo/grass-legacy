...
static int (*Open_array[])() = { dummy, V1_open_old, V2_open_old };
static int (*Open_update_array[])() = { dummy, V1__open_update_1, V2__open_update_1 };
    ...
    char *name;
{
    ...
    {
	Open_level = 0;
	return  V2__open_new_1 (Map, name);
    }

    if (0 > V1_open_new (Map, name))
	return -1;
