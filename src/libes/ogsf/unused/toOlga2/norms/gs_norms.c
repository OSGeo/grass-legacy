/*  gs_norms.c
    Bill Brown, UI GMSL
    functions for calculating normals for regular mesh
    surface with variable resampling and masking.
*/
 ...
 * (dx different from dy, but constant throughout the mesh)
 ...
 * must be unpacked (see FNORM in gsget.h) at time of use.
 */
