...
gs_point_in_region(gs, pt, region)
geosurf *gs;
float *pt, *region;
{
...
gpd_obj(gs, color, size, marker, pt)
geosurf *gs;  /* NULL if 3d obj or const elev surface */
int color, marker;
float size;
Point3 pt;
{
