...
/* first color? */
    if (pcolr->min > pcolr->max)
    {
	pcolr->red = (uchar *) G_malloc (sizeof(uchar));
	pcolr->grn = (uchar *) G_malloc (sizeof(uchar));
	pcolr->blu = (uchar *) G_malloc (sizeof(uchar));
