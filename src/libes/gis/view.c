...
G_put_3dview(fname, mapset, View, Win)
char *fname;
char *mapset;
...
G_get_3dview(fname, mapset, View)
char *fname;
char *mapset;
struct G_3dview *View;
{
...
static int
compare_wind(savedwin,curwin)
struct Cell_head *savedwin, *curwin;
{
