...
I_ask_signature_file_any (prompt, group, subgroup, name)
    char *prompt;
    char *group;
    char *subgroup;
    char *name;
...
I_ask_signature_file_old (prompt, group, subgroup, name)
    char *prompt;
    char *group;
    char *subgroup;
    char *name;
...
FILE *
I_fopen_signature_file_new (group, subgroup, name)
    char *group;
    char *subgroup;
    char *name;
{
...
FILE *
I_fopen_signature_file_old (group, subgroup, name)
    char *group;
    char *subgroup;
    char *name;
{
