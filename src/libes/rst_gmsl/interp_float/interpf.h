...
/* vinput2d.c */
int IL_vector_input_data_2d(struct interp_params *, struct Map_info *, struct Categories *, int, struct tree_info *, double *, double *, double *, double *, double *, double *, int *, double *);
