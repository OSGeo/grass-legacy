...
/*----------------------------------------------------------------*/
int 
I_get_ref_points (char *groupname, Control_Points_2D *cp)
{
    FILE *fd;
    char msg[100];
    int stat;
...
/*----------------------------------------------------------------*/
int 
I_put_ref_points (char *groupname, Control_Points_2D *cp)
{
    FILE *fd;
    char msg[100];
...
/*----------------------------------------------------------------*/
int 
I_new_ref_point (Control_Points_2D *cp, double e1, double n1, double e2, double n2, int status)
{
    int i;
    unsigned int size;
...
/*----------------------------------------------------------------*/
int 
I_read_ref_points (FILE *fd, Control_Points_2D *cp)
{
    char buf[100];
    double e1,e2,n1,n2;
    int status;
...
/*----------------------------------------------------------------*/
int 
I_write_ref_points (FILE *fd, Control_Points_2D *cp)
{
    int i;
