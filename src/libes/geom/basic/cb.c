...
/*VARARGS1*/
int basic_cb_printf (char *format, ...)
       /* This acts like a fprintf (stdout,) function on the buffer!
...
/*VARARGS1*/
char * basic_cb_frmt (char *format, ...)
