...
/*								*/
/*	This function transforms the coordinates (x,y) 		*/
/*	according to user defined rotation 'theta' about the 	*/
/*	origin of the pattern and 2-D translation defined 	*/
/*	by 'translation_x' and 'translation_y'.			*/
/*								*/
/****************************************************************/
