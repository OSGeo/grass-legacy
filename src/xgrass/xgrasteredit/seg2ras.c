...
#  ifdef DEBUG
   fprintf (stdout,"seg2ras: saving %s@%s\n",Global.rname,G_mapset());
#  endif
...
#  ifdef DEBUG
   fprintf (stdout,"seg2ras: region set\n");
#  endif
...
#  ifdef DEBUG
   fprintf (stdout,"seg2ras: raster written\n");
#  endif
...
#  ifdef DEBUG
   fprintf (stdout,"seg2ras: cats written\n");
#  endif
...
#  ifdef DEBUG
   fprintf (stdout,"seg2ras: colors written\n");
#  endif
