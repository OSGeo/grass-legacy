...
#   ifdef DEBUG
    fprintf (stdout,"Got the screen ptr\n");
#   endif

    CreateLayout(shell);
#   ifdef DEBUG
    fprintf (stdout,"back from CreateLayout\n");
#   endif
...
#   ifdef DEBUG
    fprintf (stdout,"About to init the Xgd library\n");
#   endif
...
#   ifdef DEBUG
    fprintf (stdout,"About to init our friend, Mr. Object\n");
#   endif
...
#   ifdef DEBUG
    fprintf (stdout,"About to allocate colors\n");
#   endif
