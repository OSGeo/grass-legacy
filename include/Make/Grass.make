...
EDITLIB     = $(ARCH_LIBDIR)/$(STLIB_PREFIX)$(EDIT_LIBNAME).$(STLIB_SUFFIX)
...
IMAGELIB    = $(ARCH_LIBDIR)/$(STLIB_PREFIX)$(IMAGE_LIBNAME).$(STLIB_SUFFIX)
...
# Interpolation
INTERPDATALIB = $(ARCH_LIBDIR)/$(STLIB_PREFIX)$(INTERPDATA_LIBNAME).$(STLIB_SUFFIX)
INTERPFLLIB   = $(ARCH_LIBDIR)/$(STLIB_PREFIX)$(INTERPFL_LIBNAME).$(STLIB_SUFFIX)
QTREELIB      = $(ARCH_LIBDIR)/$(STLIB_PREFIX)$(QTREE_LIBNAME).$(STLIB_SUFFIX)

OGSFLIB      = $(ARCH_LIBDIR)/$(STLIB_PREFIX)$(OGSF_LIBNAME).$(STLIB_SUFFIX)
...
RTREELIB    = $(ARCH_LIBDIR)/$(STLIB_PREFIX)$(RTREE_LIBNAME).$(STLIB_SUFFIX)
