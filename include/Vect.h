...
long Vect_next_line_offset_ogr (struct Map_info *);
...
long Vect_last_line_offset_ogr (struct Map_info *);
...
int V1_read_line_ogr (struct Map_info *, struct line_pnts *, struct line_cats *, long);
...
int Vect_build_shp ( struct Map_info *, int, FILE *);
int Vect_build_ogr ( struct Map_info *, int, FILE *);
int Vect_build_post ( struct Map_info *, int, FILE *);
