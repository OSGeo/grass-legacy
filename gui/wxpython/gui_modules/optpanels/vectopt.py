...
class MyPanel(wx.ScrolledWindow):
	...
	# begin wxGlade: MyPanel.__init__
    	...
    	self.basemap_button = wx.BitmapButton(self, -1, wx.Bitmap("/Applications/Grass/GRASS.app/Contents/Resources/etc/gui/icons/element-cell.gif", wx.BITMAP_TYPE_ANY))
    	...
    	self.drapemap_button = wx.BitmapButton(self, -1, wx.Bitmap("/Applications/Grass/GRASS.app/Contents/Resources/etc/gui/icons/element-cell.gif", wx.BITMAP_TYPE_ANY))
