...
class Data:
    ...
    def GetMenu(self):
        return [(
          ...
          ("Vector", (
              ("Develop map", (
                ("Digitize vector", "Digitize/edit vector map", "self.OnMenuCmd", "v.digit"),
                ("","","", ""),
                ("Create/rebuild topology", "Create or rebuild topology of vector objects", "self.OnMenuCmd", "v.build"),
                ("Clean vector", "Clean vector objects", "self.OnMenuCmd", "v.clean"),
                ("","","", ""),
                ...
                ("","","", ""),
                ("Create 3D vector over raster", "Create 3D objects by sampling raster with 2D vector", "self.OnMenuCmd", "v.drape"),
                ("Extrude 3D vector", "Extrude 3D objects from 2D vector", "self.OnMenuCmd", "v.extrude"),
                ("","","", ""),
              ...
              ("Query with another map", "Query objects using objects from a second map", "self.OnMenuCmd", "v.select"),
              ("","","", ""),
              ...
              ("Change attributes", (
                ...
                ("Reclassify objects using rules", "Reclassify vector objects interactively using rules", "self.RulesCmd", "v.reclass"),
                ("Reclassify objects using rules file", "Reclassify vector objects using rules file", "self.OnMenuCmd", "v.reclass"),
                )),
              ("","","", ""),
