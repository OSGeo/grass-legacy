...
/* asprintf.c ......Deleted By Sajith VK */
/* auto_mask.c */
...
/* def_window.c 
int G_def_window(struct Cell_head *);Commented by SajithVK*/
...
int G_edit_fp_cats(char *, struct Categories *); Commented By sajithVK*/

/* edit_cellhd.c 
int G_edit_cellhd(struct Cell_head *, int); Commented by sajithVK*/

/* edit_hist.c 
int G_edit_history(struct History *); Commented By sajithvk*/
...
int G_warning(char *,...) __attribute__((format(printf,1,2)));        Commented by sajithvk */
...
/* grid_dist1.c 
double G_ellipsoid_grid_dist(double, double, double, double, double, double);Commented By sajithvk*/
...
int G_lzw_transfer_expand(int, int, int); Commented by sajithvk*/
...
FILE *G_fopen_support_new(char *, char *, char *);Commented by sajithvk*/
