...
inline void sparse_matrix_vector_product (N_les * les, double *source, double *result);
inline int check_symmetry (N_les * les);	/*not jet implemented */
inline void scalar_product (double *source_a, double *source_b, double *result, int row);
inline void sub_vectors (double *source_a, double *source_b, double *result, int row);
inline void sub_vectors_scalar (double *source_a, double *source_b, double *result, double scalar_b, int rows);
inline void add_vectors (double *source_a, double *source_b, double *result, int rows);
inline void add_vectors_scalar (double *source_a, double *source_b, double *result, double scalar_b, int rows);
inline void add_vectors_scalar2 (double *source_a, double *source_b, double *result, double scalar_a, double scalar_b,
				 int rows);
inline void scalar_vector_product (double *source, double *result, double skalar, int rows);
 ...
 * */
int
N_solver_cg (N_les * L, int maxit, double err)
{
  double *r;
  double *p;
  double *v;
 ...
 * */
int
N_solver_bicgstab (N_les * L, int maxit, double err)
{
  double *r;
  double *r0;
  double *p;
 ...
 * */
int
N_solver_gauss (N_les * les)
{

  if (les->type != N_NORMAL_LES)
    G_fatal_error ("The gauss elimination solver works only with normal quadratic matrices");
 ...
 * */
void
scalar_product (double *a, double *b, double *scalar, int rows)
{
  int i;
  double s = 0.0;
 ...
 * */
void
matrix_vector_product (N_les * L, double *x, double *result)
{
  int i, j;
  double tmp;
 ...
 * */
void
sparse_matrix_vector_product (N_les * L, double *x, double *result)
{
  int i, j;
  double tmp;
 ...
 * */
void
add_vectors_scalar2 (double *a, double *b, double *result, double scalar_a, double scalar_b, int rows)
{
  int i;
 ...
 * */
void
add_vectors_scalar (double *a, double *b, double *result, double scalar_b, int rows)
{
  int i;
 ...
 * */
void
sub_vectors_scalar (double *a, double *b, double *result, double scalar_b, int rows)
{
  int i;
 ...
 * */
void
add_vectors (double *a, double *b, double *result, int rows)
{
  int i;
 ...
 * */
void
sub_vectors (double *a, double *b, double *result, int rows)
{
  int i;
 ...
 * */
void
scalar_vector_product (double *a, double *result, double scalar, int rows)
{
  int i;
 ...
 * */
void
sync_vectors (double *source, double *target, int rows)
{
  int i;
 ...
 * */
void
gauss_elimination (double **A, double *b, int rows)
{
  int i, j, k;
  double tmpval = 0.0;
 ...
 * */
void
lu_decomposition (double **A, int rows)
{
 ...
 * */
void
backward_solving (double **A, double *x, double *b, int rows)
{
  int i, j;
  double tmpval = 0.0;
 ...
 * */
void
forward_solving (double **A, double *x, double *b, int rows)
{
  int i, j;
  double tmpval = 0.0;
