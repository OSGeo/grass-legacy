...
/* *************************************************************** */
N_array_2d *
create_status_array_2d ()
{
  N_array_2d *data;
  int i, j;

  data = N_alloc_array_2d (TEST_N_NUM_ROWS, TEST_N_NUM_COLS, 1, CELL_TYPE);
...
/* *************************************************************** */
N_array_2d *
create_value_array_2d ()
{
  N_array_2d *data;
  int i, j;

  data = N_alloc_array_2d (TEST_N_NUM_ROWS, TEST_N_NUM_COLS, 1, DCELL_TYPE);
...
/* *************************************************************** */
N_array_3d *
create_status_array_3d ()
{
  N_array_3d *data;
  int k, i, j;

  data = N_alloc_array_3d (TEST_N_NUM_DEPTHS, TEST_N_NUM_ROWS, TEST_N_NUM_COLS, 1, G3D_FLOAT);
	...
	for (j = 0; j < TEST_N_NUM_COLS; j++)
	  {
	    ...
	    if (i == 0)
	      {
		N_put_array_3d_value_float (data, k, i, j, 2.0);
	      }
	    else
	      {

		N_put_array_3d_value_float (data, k, i, j, 1.0);
	      }
	  }
      }
...
/* *************************************************************** */
N_array_3d *
create_value_array_3d ()
{
  N_array_3d *data;
  int k, i, j;

  data = N_alloc_array_3d (TEST_N_NUM_DEPTHS, TEST_N_NUM_ROWS, TEST_N_NUM_COLS, 1, G3D_DOUBLE);
	...
	for (j = 0; j < TEST_N_NUM_COLS; j++)
	  {
	    ...
	    if (i == 0)
	      {
		N_put_array_3d_value_float (data, k, i, j, 50);
	      }
	    else
	      {
