...
extern inline double N_calc_arith_mean(double a, double b);
extern inline double N_calc_arith_mean_n(double *a, int size);
extern inline double N_calc_geom_mean(double a, double b);
extern inline double N_calc_geom_mean_n(double *a, int size);
extern inline double N_calc_harmonic_mean(double a, double b);
extern inline double N_calc_harmonic_mean_n(double *a, int size);
extern inline double N_calc_quad_mean(double a, double b);
extern inline double N_calc_quad_mean_n(double *a, int size);
...
extern N_gradient_neighbours_2d *N_get_gradient_neighbours_2d(N_gradient_field_2d * field,
...
extern N_gradient_field_3d * N_compute_gradient_field_3d(N_array_3d *pot, N_array_3d *weight_x, N_array_3d *weight_y, N_array_3d *weight_z, N_geom_data *geom, N_gradient_field_3d * gradfield);
