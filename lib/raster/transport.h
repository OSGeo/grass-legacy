...
extern void LOC_color_offset(int n);
...
extern void LOC_polydots_abs(int *xarray, int *yarray, int number);
extern void LOC_polydots_rel(int *xarray, int  *yarray, int number);
extern void LOC_polyline_abs(int *xarray, int  *yarray, int number);
extern void LOC_polyline_rel(int *xarray, int *yarray, int number);
extern void LOC_polygon_abs(int *xarray, int *yarray, int number);
extern void LOC_polygon_rel(int *xarray, int *yarray, int number);
...
extern void LOC_get_text_box(const char *text, int *t, int *b, int *l, int *r);
extern void LOC_font(const char *name);
extern void LOC_font_freetype(const char *name);
extern void LOC_charset(const char *name);
extern void LOC_font_freetype_release(void);
...
extern void REM_color_offset(int n);
...
extern void REM_polydots_abs(int *xarray, int *yarray, int number);
extern void REM_polydots_rel(int *xarray, int  *yarray, int number);
extern void REM_polyline_abs(int *xarray, int  *yarray, int number);
extern void REM_polyline_rel(int *xarray, int *yarray, int number);
extern void REM_polygon_abs(int *xarray, int *yarray, int number);
extern void REM_polygon_rel(int *xarray, int *yarray, int number);
...
extern void REM_get_text_box(const char *text, int *t, int *b, int *l, int *r);
extern void REM_font(const char *name);
extern void REM_font_freetype(const char *name);
extern void REM_charset(const char *name);
extern void REM_font_freetype_release(void);
...
struct transport
{
	...
	void (*polydots_abs)(int *, int *, int);
	void (*polydots_rel)(int *, int  *, int);
	void (*polyline_abs)(int *, int  *, int);
	void (*polyline_rel)(int *, int *, int);
	void (*polygon_abs)(int *, int *, int);
	void (*polygon_rel)(int *, int *, int);
	...
	void (*font_freetype)(const char *);
	void (*charset)(const char *);
	void (*font_freetype_release)(void);
