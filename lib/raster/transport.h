...
extern void LOC_polydots_abs(const int *xarray, const int *yarray, int number);
extern void LOC_polydots_rel(const int *xarray, const int *yarray, int number);
extern void LOC_polyline_abs(const int *xarray, const int *yarray, int number);
extern void LOC_polyline_rel(const int *xarray, const int *yarray, int number);
...
extern void REM_polydots_abs(const int *xarray, const int *yarray, int number);
extern void REM_polydots_rel(const int *xarray, const int *yarray, int number);
extern void REM_polyline_abs(const int *xarray, const int *yarray, int number);
extern void REM_polyline_rel(const int *xarray, const int *yarray, int number);
