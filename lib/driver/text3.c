...
static void draw_text(FT_Face,FT_Vector*,FT_Matrix*,const unsigned char *,int,int);
	...
	const char *string)
{
	...
	ans = FT_Set_Char_Size(face, (int) (text_size_x * 64), (int) (text_size_y * 64), 100, 100);
	/*
...
static void draw_text(FT_Face face, FT_Vector* pen, FT_Matrix* matrix, const unsigned char *out, int len, int color)
{
	FT_ULong ch;
	FT_Error ans;
