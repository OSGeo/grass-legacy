...
int 
color_name_is_ok (char *color_name)
{
    int i;
...
void 
unset_color ( PSCOLOR *pscolor) {
    pscolor->none = 1;
}

void 
set_color ( PSCOLOR *pscolor, int r, int g, int b)
{
    pscolor->none = 0;
...
void 
set_color_from_color ( PSCOLOR *pscolor, int color)
{
    float r, g, b;
