...
/* TODO:
   ...
   ./gem65 --grass=/usr/local/grass-6.5.svn -q
   NOT like this:
   ./gem65 -q --grass=/usr/local/grass-6.5.svn
...
void show_help(void)
{
    fprintf(stdout, "Usage: gem65 [OPTION] [ACTION] [FILE|DIR]\n");
    ...
    fprintf(stdout, "\nExample:\n");
    fprintf(stdout,
	    "\tgem65 -b macosx --grass=/usr/local/grass-6.5.0 -i myExtension\n");
    fprintf(stdout,
	    "Installs the MacOS X binaries for 'myExtension' in /usr/local/grass-6.5.0.\n");
    exit(0);
}
...
{
    fprintf(stdout, "gem65 (GRASS extensions manager) %.2f\n", PROGVERSION);
